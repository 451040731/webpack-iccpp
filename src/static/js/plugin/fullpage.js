    ...
    c.fn.fullpage = function(d) {
        function La() {
            ...
            c('.fp-section').each(function(a) {
                ...
                'undefined' !== typeof d.anchors[a] &&
                    ...
                    b.hasClass('active') && I(d.anchors[a], a));
                d.menu &&
                    d.css3 &&
            ...
            d.navigation && Pa();
            d.scrollOverflow
                ? ('complete' === m.readyState && ja(), n.on('load', ja))
                : ka();
            la();
            if (
                !d.animateAnchor &&
                ...
                b.length &&
                    (d.autoScrolling
                        ? x(b.position().top)
                        : (x(0), t.scrollTop(b.position().top)),
                    I(a, null),
            ...
            if (!d.autoScrolling || d.scrollBar) {
                for (
                    var b = n.scrollTop(),
                        ...
                        h = m.querySelectorAll('.fp-section'),
                        k = 0;
                    k < h.length;
                    ++k
                ) {
                ...
                if (!a.hasClass('active') && !a.hasClass('fp-auto-height')) {
                    ...
                    y &&
                        (a
                            ...
                            .siblings()
                            .removeClass('active'),
                        c.isFunction(d.onLeave) && d.onLeave.call(b, g, k, f),
                        c.isFunction(d.afterLoad) && d.afterLoad.call(a, h, k),
                        K(a),
                        e.setFitToSection(!a.hasClass('fp-auto-height')),
                        I(h, k - 1),
                        d.anchors.length && ((A = h), Y(q, r, h, k)));
                    clearTimeout(Z);
        ...
        function Sa(a) {
            ...
            if (!qa(a.target) && ba(b)) {
                ...
                y &&
                    ...
                    (D = b.y),
                    (M = b.x),
                    a.find('.fp-slides').length && p.abs(N - M) > p.abs(E - D)
                        ? p.abs(N - M) >
                              (n.width() / 100) * d.touchSensitivity &&
                          (N > M
                              ? k.m.right && e.moveSlideRight()
                              : k.m.left && e.moveSlideLeft())
                        : d.autoScrolling &&
                          p.abs(E - D) >
                ...
                if ('undefined' !== typeof f) {
                    ...
                    if (
                        ...
                        d.autoScrolling &&
                            ...
                            x(c('.fp-section.active').position().top),
                            va(),
        ...
        function Va(a) {
            if (d.css3 && d.autoScrolling && !d.scrollBar)
                wa('translate3d(0px, -' + a.dtop + 'px, 0px)', !0),
                    d.scrollingSpeed
        ...
        function F(a, b) {
            ...
            if (d.onSlideLeave) {
                ...
                if (
                    ...
                    !1 === d.onSlideLeave.call(r, k, h + 1, q, t, f)
                ) {
                    z = !1;
                    return;
                }
        ...
        function Za() {
            if (Q || R) {
                ...
                c('.fullpage-wrapper')
                    ...
                    .on('touchstart ' + a.down, Ta);
                c('.fullpage-wrapper')
                    .off('touchmove ' + a.move)
                    .on('touchmove ' + a.move, Sa);
            }
        }
        function $a() {
            if (Q || R) {
        ...
        e.setMouseWheelScrolling = function(a) {
            a
                ? m.addEventListener
                    ? (m.addEventListener('mousewheel', u, !1),
                      m.addEventListener('wheel', u, !1),
                      m.addEventListener('DOMMouseScroll', u, !1))
                    : m.attachEvent('onmousewheel', u)
                : m.addEventListener
                ? (m.removeEventListener('mousewheel', u, !1),
                  m.removeEventListener('wheel', u, !1),
                  m.removeEventListener('DOMMouseScroll', u, !1))
                : m.detachEvent('onmousewheel', u);
        };
        e.setAllowScrolling = function(a, b) {
            'undefined' !== typeof b
                ...
                : a
                ? (e.setMouseWheelScrolling(!0), Za())
                : (e.setMouseWheelScrolling(!1), $a());
        };
        ...
        var z = !1,
            ...
            C = [],
            O,
            k = { m: { up: !0, down: !0, left: !0, right: !0 } };
        k.k = c.extend(!0, {}, k.m);
        var G = c.extend(!0, {}, d),
            ha,
            ca,
        ...
        d.normalScrollElements &&
            (w.on('mouseenter', d.normalScrollElements, function() {
