...
(function(d, f, b) {
    ...
    var e = {
        ...
        w: {
            '*': 'not be empty!',
            '*6-16': 'Please fill in 6 to 16 characters!',
            ...
            e: 'The email address is in the wrong format!',
    ...
    var a = function(l, n, k) {
        ...
        l.each(function() {
            ...
            o.find("[type='reset']")
                .add(o.find(p.settings.btnReset))
                .bind('click', function() {
        ...
        if (
            n.tiptype == 1 ||
            ((n.tiptype == 2 || n.tiptype == 3) && n.ajaxPost)
        ) {
            c();
        }
    };
    ...
    a.util = {
        ...
        getValue: function(m) {
            ...
            if (m.is(':radio')) {
                l = k
                    .find(":radio[name='" + m.attr('name') + "']:checked")
                    .val();
                l = l === b ? '' : l;
            } else {
                if (m.is(':checkbox')) {
                ...
                if (l == 2) {
                    if (
                        ...
                        d(this)
                            .parent()
                            .next()
                            .append("<span class='Validform_checktip' />");
                        d(this)
                    ...
                    if (l == 3 || l == 4) {
                        if (
                            d(this).siblings('.Validform_checktip').length == 0
                        ) {
                            d(this)
                                .parent()
                                .append("<span class='Validform_checktip' />");
        ...
        usePlugin: function(o, l, n, r) {
            var s = this,
                o = o || {};
            if (
                s.find("input[plugin='swfupload']").length &&
            ...
            if (
                s.find("input[plugin='datepicker']").length &&
                d.fn.datePicker
            ) {
                ...
                s.find("input[plugin='datepicker']").each(function(t) {
                    ...
                    o.datepicker.callback &&
                        d(this).bind('dateSelected', function() {
                            var u = new Date(
                                d.event._dpCache[this._dpId].getSelected()[0]
            ...
            if (
                s.find("input[plugin*='passwordStrength']").length &&
            ...
            if (r != 'addRule' && o.jqtransform && d.fn.jqTransSelect) {
                ...
                var p = function(t) {
                    if (
                        d(t.target).parents('.jqTransformSelectWrapper')
                            .length === 0
                    ) {
                        m(d(t.target));
                    }
                ...
                if (o.jqtransform.selector) {
                    s.find(o.jqtransform.selector)
                        .filter(
                            'input:submit, input:reset, input[type="button"]'
                        )
                        .jqTransInputButton();
                    s.find(o.jqtransform.selector)
                        .filter('input:text, input:password')
                        .jqTransInputText();
                    s.find(o.jqtransform.selector)
                    ...
                    s.find(o.jqtransform.selector)
                        ...
                        .jqTransTextarea();
                    if (
                        s.find(o.jqtransform.selector).filter('select').length >
                        0
                    ) {
                        s.find(o.jqtransform.selector)
                            .filter('select')
                ...
                s.find('.jqTransformSelectWrapper')
                    .find('li a')
                    .click(function() {
                        d(this)
                            .parents('.jqTransformSelectWrapper')
                            .find('select')
                            .trigger('blur');
                    });
            }
        ...
        getErrormsg: function(s, n, u) {
            ...
            for (var k in p) {
                if (k.indexOf(q[1]) != -1 && m.test(k)) {
                    r = (s.data('tipmsg').w[k] || e.w[k]).replace(
                        l,
                        '$1' + q[3] + '$2' + q[4] + '$3'
                    );
        ...
        _regcheck: function(t, n, u, A) {
            ...
            if (o.test(t)) {
                ...
                if (
                    a.util.toString.call(a.util.dataType[t]) ==
                    '[object Function]'
                ) {
            ...
            if (v) {
                ...
                if (u.attr('recheck')) {
                    var p = A.find(
                        "input[name='" + u.attr('recheck') + "']:first"
                    );
                    if (n != p.val()) {
                        v = false;
                        l = 3;
        ...
        showmsg: function(n, l, m, k) {
            ...
            if (
                k == 'bycheck' &&
                m.sweep &&
                ((m.obj && !m.obj.is('.Validform_error')) ||
                    typeof l == 'function')
            ) {
                return;
            }
        ...
        check: function(v, t, n) {
            ...
            if (
                (o.ignoreHidden && d(this).is(':hidden')) ||
            ...
            var s = a.util.regcheck.call(
                v,
                d(this).attr('datatype'),
                k,
                d(this)
            );
            if (
                k == this.validform_lastval &&
                !d(this).attr('recheck') &&
                t == ''
            ) {
                ...
                var p = {
                    ...
                    success: function(x) {
                        if (x.ok) {
                            ...
                            a.util.showmsg.call(
                                v,
                                m.attr('sucmsg') || v.data('tipmsg').r || e.r,
                                o.tiptype,
                                {
                                    obj: m,
                                    type: 2,
        ...
        resetForm: function() {
            ...
            k.find('.passwordStrength')
                .children()
                .removeClass('bgStrength');
        ...
        var l = (d(window).width() - n.outerWidth()) / 2,
            ...
            k =
                (document.documentElement.scrollTop
                    ? document.documentElement.scrollTop
                    : document.body.scrollTop) + (k > 0 ? k : 0);
        n.css({
            left: l,
        }).animate(
            {
...
/*
 ...
 num锛氬尮閰嶆暟鍊煎瀷
 qq锛氬尮閰峲q鍙风爜
 unequal锛氬綋鍓嶅€间笉鑳界瓑浜庤妫€娴嬬殑鍊硷紝濡傚彲浠ョ敤鏉ユ娴嬫柊瀵嗙爜涓嶈兘涓庢棫瀵嗙爜涓€鏍�
 notvalued锛氬綋鍓嶅€间笉鑳藉寘鍚寚瀹氬€硷紝濡傚瘑鐮佷笉鑳藉寘鍚敤鎴峰悕绛夌殑妫€娴�
 min锛氬閫夋鏈€灏戦€夋嫨澶氬皯椤�
 max锛氬閫夋鏈€澶氫笉鑳借秴杩囧灏戦」
 byterange:鍒ゆ柇瀛楃闀垮害锛屼腑鏂囩畻涓や釜瀛楃
 numrange锛氬垽鏂暟鍊艰寖鍥达紝濡傚皬浜�100澶т簬10涔嬮棿鐨勬暟
 daterange锛氬垽鏂棩鏈熻寖鍥�
 idcard锛氬韬唤璇佸彿鐮佽繘琛屼弗鏍奸獙璇�
 */
...
if ($.Datatype) {
    $.extend($.Tipmsg.w, {
        ...
        dword: 'Please fill in double-byte characters!',
        money: 'Please fill in the currency value!',
        ...
        unequal: 'Values cannot be equal!',
        notvalued: "Can't contain a specific value!",
        idcard: 'The ID card number is wrong!',
        floatnumber: 'Incorrect format',
    });
    ...
    $.extend($.Datatype, {
        /*
         ...
         鏃ユ湡鏍煎紡鍙互鏄細20120102 / 2012.01.02 / 2012/01/02 / 2012-01-02
         鏃堕棿鏍煎紡鍙互鏄細10:01:10 / 02:10
         濡� 2012-01-02 02:10
         2012-01-02
         */
        //濮撳悕
        ...
        captcha: function(gets, obj, curform, regxp) {
            var reg = /^[a-zA-Z0-9]{4}$/;
            if (!reg.test(gets)) {
                return 'Please enter a 4-bit verification code';
            }
            return true;
        },
        ...
        smsCode: function(gets, obj, curform, regxp) {
            var reg = /^\d{6}$/;
            if (!reg.test(gets)) {
                return 'Please enter a 6-bit verification code';
            }
            return true;
        },
        ...
        /*
         ...
         datatype涓哄唴缃殑涓€浜涙鍒欒〃杈惧紡鐨勫紩鐢ㄣ€�
         */
        unequal: function(gets, obj, curform, datatype) {
            /*
             褰撳墠鍊间笉鑳戒笌鎸囧畾琛ㄥ崟鍏冪礌鐨勫€间竴鏍凤紝濡傛柊瀵嗙爜涓嶈兘涓庢棫瀵嗙爜涓€鏍凤紝瀵嗙爜涓嶈兘璁剧疆涓虹敤鎴峰悕绛�
             娉ㄦ剰闇€瑕侀€氳繃缁戝畾with灞炴€ф潵鎸囧畾瑕佹瘮杈冪殑琛ㄥ崟鍏冪礌锛屽彲浠ユ槸clas锛宨d鎴栬€呮槸name灞炴€у€�
             ...
             涔熷彲浠ョ敤鏉ラ獙璇佷笉鑳戒笌with鎸囧畾鐨勫€肩浉绛�
             褰撲笂闈㈡牴鎹甤lass锛宨d鍜宯ame閮芥煡鎵句笉鍒板璞℃椂锛屼細鐩存帴璺焪ith鐨勫€兼瘮杈�
             eg4. <input type="text" name="test" datatype="num unequal" with="100" />
             璇ユ枃鏈鐨勫€间笉鑳界瓑浜�100
             */
            var withele = $.trim(obj.attr('with'));
            var val =
                curform.find(withele + ",[name='" + withele + "']").val() ||
                withele;
        ...
        notvalued: function(gets, obj, curform, datatype) {
            /*
             褰撳墠鏂囨湰妗嗙殑鍊间笉鑳藉惈鏈夋寚瀹氭枃鏈鐨勫€硷紝濡傛敞鍐屾椂璁剧疆鐨勫瘑鐮侀噷涓嶈兘鍖呭惈鐢ㄦ埛鍚�
             娉ㄦ剰闇€瑕佺粰琛ㄥ崟鍏冪礌缁戝畾with灞炴€ф潵鎸囧畾瑕佹瘮杈冪殑琛ㄥ崟鍏冪礌锛屽彲浠ユ槸clas锛宨d鎴栬€呮槸name灞炴€у€�
             <input type="text" name="username" id="name" class="name" />
             eg. <input type="password" name="test" datatype="notvalued" with=".name" />

             涔熷彲浠ョ敤鏉ラ獙璇佷笉鑳藉寘鍚玾ith鎸囧畾鐨勫€�
             褰撲笂闈㈡牴鎹甤lass锛宨d鍜宯ame閮芥煡鎵句笉鍒板璞℃椂锛屼細鐩存帴璺焪ith鐨勫€兼瘮杈�
             eg2. <input type="password" name="test" datatype="notvalued" with="validform" />
             瑕佹眰涓嶈兘鍚湁"validform"瀛楃
             */
            var withele = $.trim(obj.attr('with'));
            var val =
                curform.find(withele + ",[name='" + withele + "']").val() ||
        ...
        min: function(gets, obj, curform, datatype) {
            /*
             checkbox鏈€灏戦€夋嫨n椤�
             娉ㄦ剰闇€瑕佺粰琛ㄥ崟鍏冪礌缁戝畾min灞炴€ф潵鎸囧畾鏄嚦灏戦渶瑕侀€夋嫨鍑犻」锛屾病鏈夌粦瀹氱殑璇濅娇鐢ㄩ粯璁ゅ€�
             eg. <input type="checkbox" name="test" datatype="min" min="3" />
             */

            var minim = ~~obj.attr('min') || 2,
                numselected = curform.find(
                    "input[name='" + obj.attr('name') + "']:checked"
                ).length;
            return numselected >= minim
                ? true
                : '璇疯嚦灏戦€夋嫨' + minim + '椤癸紒';
        },
        ...
        max: function(gets, obj, curform, datatype) {
            /*
             checkbox鏈€澶氶€夋嫨n椤�
             娉ㄦ剰闇€瑕佺粰琛ㄥ崟鍏冪礌缁戝畾max灞炴€ф潵鎸囧畾鏄渶澶氶渶瑕侀€夋嫨鍑犻」锛屾病鏈夌粦瀹氱殑璇濅娇鐢ㄩ粯璁ゅ€�
        ...
        byterange: function(gets, obj, curform, datatype) {
            /*
             鍒ゆ柇瀛楃闀垮害锛屼腑鏂囩畻涓や釜瀛楃
             娉ㄦ剰闇€瑕佺粰琛ㄥ崟鍏冪礌缁戝畾max,min灞炴€ф潵鎸囧畾鏈€澶ф垨鏈€灏忓厑璁哥殑瀛楃闀垮害锛屾病鏈夌粦瀹氱殑璇濅娇鐢ㄩ粯璁ゅ€�
             */
            var dregx = /[^\x00-\xff]/g;
        ...
        numrange: function(gets, obj, curform, datatype) {
            /*
             鍒ゆ柇鏁板€艰寖鍥�
             娉ㄦ剰闇€瑕佺粰琛ㄥ崟鍏冪礌缁戝畾max,min灞炴€ф潵鎸囧畾鏈€澶ф垨鏈€灏忓彲杈撳叆鐨勫€硷紝娌℃湁缁戝畾鐨勮瘽浣跨敤榛樿鍊�
             */
        ...
        daterange: function(gets, obj, curform, datatype) {
            /*
             鍒ゆ柇鏃ユ湡鑼冨洿
             娉ㄦ剰闇€瑕佺粰琛ㄥ崟鍏冪礌缁戝畾max鎴杕in灞炴€э紝鎴栦袱涓悓鏃剁粦瀹氭潵鎸囧畾鏈€澶ф垨鏈€灏忓彲杈撳叆鐨勬棩鏈�
             鏃ユ湡鏍煎紡锛�2012/12/29 鎴� 2012-12-29 鎴� 2012.12.29 鎴� 2012,12,29
             */
            ...
            if (gets > maxim) {
                return 'Date cannot be greater than' + obj.attr('max');
            }

            if (gets < minim) {
                return 'Date cannot be less than' + obj.attr('min');
            }
        ...
        idcard: function(gets, obj, curform, datatype) {
            ...
            function isTrueValidateCodeBy18IdCard(a_idCard) {
                ...
                if (a_idCard[17].toLowerCase() == 'x') {
                    a_idCard[17] = 10;
                    // 灏嗘渶鍚庝綅涓簒鐨勯獙璇佺爜鏇挎崲涓�10鏂逛究鍚庣画鎿嶄綔
                }
                for (var i = 0; i < 17; i++) {
                    sum += Wi[i] * a_idCard[i];
                    // 鍔犳潈姹傚拰
