(function(config) {
    ...
    function pa() {
        ...
        if (0 <= a.indexOf('intel')) {
            ...
            (0 <= a.indexOf('gma') ||
                0 <= a.indexOf('graphics media accelerator')) &&
                b.push('GMA');
    ...
    var sa = 'microsoft basic render driver;vmware svga 3d;Intel 965GM;Intel B43;Intel G41;Intel G45;Intel G965;Intel GMA 3600;Intel Mobile 4;Intel Mobile 45;Intel Mobile 965'.split(
        ...
        xa =
            ('devicePixelRatio' in da && 1 < da.devicePixelRatio) ||
            (ua &&
                'matchMedia' in da &&
                da.matchMedia('(min-resolution:144dpi)') &&
                da.matchMedia('(min-resolution:144dpi)').matches),
        ya = ia('windows nt'),
    ...
    var Ua = Ra
        ...
        ib = ia('baidubrowser'),
        chrome =
            (ia('chrome') || ia('crios')) && !gb && !ib && !hb && !bb && !fb,
        ...
        pb = Na && ia('aliapp'),
        qb =
            Na && ((!hb && !db && !gb && !chrome && !lb && !nb) || (pb && !db)),
        rb = Ra || Na || Da || ia('mobile'),
        sb = 'ontouchstart' in ga,
        tb =
            da.navigator &&
            da.navigator.msPointerEnabled &&
            !!da.navigator.msMaxTouchPoints,
        ...
        Ab =
            !!ga.createElementNS &&
            !!ga.createElementNS('http://www.w3.org/2000/svg', 'svg')
                .createSVGRect,
        ...
        Ib = (function() {
            if (!window.forceWebGL && (!Cb || !Eb || (qb && pb && !db)))
                return !1;
            for (
                var a = ['webgl', 'experimental-webgl', 'moz-webgl'],
                    b = null,
                    c = 0;
                c < a.length;
                c += 1
                ...
                if (b) {
                    if (
                        b.drawingBufferWidth !== Bb.width ||
                        b.drawingBufferHeight !== Bb.height
                    )
                        break;
                    if (window.forceWebGL)
                        return (Fb = a[c]), (Gb = Infinity), !0;
                    if (
                    ...
                    if (
                        23 >
                            b.getShaderPrecisionFormat(35632, 36338)
                                .precision ||
        ...
        Jb =
            Ib && (kb || mb || ob) && ('mac' === Ua || 'windows' === Ua) && !rb,
        Kb =
            !Cb ||
            cb ||
            Da ||
    ...
    window.AMap
        ? ((window.AMap.version = '1554354371599'),
          (window.AMap.II = {
              FJ: function(a) {
                  a(ec);
              },
    ...
    g.c.add = g.BuryPoint.add = function(a, b, c) {
        a.V0 ||
            a.B ||
            !(a = a.CLASS_NAME) ||
            ((a = a.replace('AMap.', '')), g.Jy.Tn(a, b, c));
    };
    ...
    g.Z.extend = g.Z.extend = function(a) {
        ...
        function c() {
            ...
            if (!d && this.bi) {
                ...
                this.bi = this.bi.replace(
                    /url\((['"]?)(?:\.\.\/)*/g,
                    'url($1' + g.w.tb + '/'
                );
                a.styleSheet
                    ? (a.styleSheet.cssText = this.bi)
                    : (a.innerHTML = this.bi);
                for (
                    var b =
                            document.head ||
    ...
    g.Z.$c = function(a) {
        for (var b in a)
            if (a.hasOwnProperty(b)) {
                ...
                if ('string' === typeof c)
                    this.prototype[b] &&
                        (this.prototype[c] = this.prototype[b]);
                else
                    for (var d = 0, e = c.length; d < e; d++)
                        this.prototype[b] &&
                            (this.prototype[c[d]] = this.prototype[b]);
            }
    };
    g.Jy = {
        Oi: {},
    ...
    g.na = {
        h: function(a, b, c, d, e) {
            ...
            f[a] = f[a] || [];
            e
                ? f[a].unshift({ rb: b, ff: c || this, vj: d })
                : f[a].push({ rb: b, ff: c || this, vj: d });
    ...
    g.He = {
        ...
        Ck: function(a) {
            this.Lk &&
                this.Lk[a] &&
                (this.Lk[a].I(a, 'mv', this), (this.Lk[a] = void 0));
        },
        Hm: function() {
            if (this.Lk)
        ...
        Axa: function(a, b, c) {
            var d = new (g.Z.extend({ ga: [g.na, g.He] }))();
            d.xva = function() {
    ...
    g.w = {
        ...
        Rt: 'http://m.amap.com',
        EB:
            'http://webrd0{1,2,3,4}.is.autonavi.com/appmaptile?lang=[lang]&size=1&scale=1&style=8&x=[x]&y=[y]&z=[z]',
        gH:
            'http://wprd0{1,2,3,4}.is.autonavi.com/appmaptile?lang=zh_cn&size=1&style=7&x=[x]&y=[y]&z=[z]&scl=1&ltype=3',
        XQ:
            'http://webst0{1,2,3,4}.is.autonavi.com/appmaptile?style=6&x=[x]&y=[y]&z=[z]',
        YH:
            'http://webst0{1,2,3,4}.is.autonavi.com/appmaptile?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scale=1&style=8',
        ZH:
            'http://wprd0{1,2,3,4}.is.autonavi.com/appmaptile?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scl=1&style=8&ltype=11',
        GC:
            'http://wprd0{1,2,3,4}.is.autonavi.com/appmaptile?lang=[lang]&size=1&style=7&x=[x]&y=[y]&z=[z]',
    ...
    g.Ml = { ft: Math.PI / 180, $oa: 180 / Math.PI, CN: 6378137 };
    (function() {
        function a(a) {
            ...
            U_: function(b) {
                if (g.l.Y) {
                    ...
                    c.push(
                        '&ios=' +
                            encodeURIComponent(
                                'viewPOIDetail?sourceApplication=jsapi_detail&poiid=' +
                                    b.id
                            )
                    );
                    b.name = a(b.name);
    ...
    g.a = {
        ...
        jb: function(a) {
            if ('object' === typeof a && null !== a) {
                if (
                    a.m2 ||
                    this.qj(a, 'Float32Array') ||
                    this.qj(a, 'Uint16Array')
                )
                    return a;
        ...
        Co: function(a) {
            ...
            if (0 == a.indexOf('#')) {
                ...
                if (9 == a.length)
                    return (
                        (a = a.substr(1)), this.ck(a.substr(6) + a.substr(0, 6))
                    );
            } else {
                if (0 == a.indexOf('rgb('))
                    return (a = this.Wpa(a)), a.push(1), a;
        ...
        ga:
            'function' === typeof Array.prototype.ga
                ? function(a, b) {
                      return a.ga(b);
                  }
                : function(a, b) {
        ...
        Qva: function(a, b) {
            ...
            for (var c = '', d = 0, e = a.length; d < e; d++)
                c += String.fromCharCode(
                    (a.charCodeAt(d) - 256 - b + 65535) % 65535
                );
            return c;
        },
        xia: function(a, b) {
        ...
        iepngFix: function(a) {
            function b() {
                for (var a; c.length; )
                    (a = c.shift()), window.DD_belatedPNG.fixPng(a);
                d.mP = !0;
            }
            ...
            window.DD_belatedPNG && this.mP
                ? setTimeout(function() {
                      b();
                  }, 100)
                : this.mP || g.ob.load('AMap.FixPng', b);
        },
        Fa: function(a) {
            if (g.a.isArray(a))
                if (g.a.isArray(a[0]))
                    for (var b = 0; b < a.length; b += 1) a[b] = g.a.Fa(a[b]);
    ...
    g.a.UH = window.requestIdleCallback
    ...
    g.a.VM = window.cancelIdleCallback
                ...
                function(b) {
                    l ||
                        ...
                        2 === b.code && 0 < b.message.indexOf('permission')
                            ? a.ob.load('AMap.GeoRemoteLoc', function() {
                                  d(null, a.u6, h);
                              })
                            : d(null, f));
                },
        ...
        var b = a.Z.extend({
            ...
            p_: function(b) {
                ...
                for (var d = 0, e = b.length; d < e; d++)
                    if (
                        a.o.Eh &&
                        b[d] instanceof a.o.Eh &&
                        b[d].ma &&
                        b[d].ma.length &&
                        (-1 !== b[d].ma.indexOf('building') ||
                            -1 !== b[d].ma.indexOf('poilabel')) &&
                        b[d].Ha
                    ) {
    ...
    (function(a) {
        ...
        function d(a) {
            ...
            'function' === typeof this._wkHandlers[e].r &&
                this._wkHandlers[e].r.call(this._wkHandlers[e]);
            a.Ps = function(a) {
                c.push.apply(c, a);
            };
            a.addEventListener(
        ...
        function e(d, h) {
            this.D = a.extend(
                { batchSend: !0, lazy: !1, libPolyfills: null },
                h
            );
            this.wo = [];
        ...
        a.extend(e.prototype, {
            ...
            TP: function(a) {
                this.qX
                    ? a.apply(null, this.qX)
                    : (this.Tv || (this.Tv = []), this.Tv.push(a));
            },
            ow: function(b) {
                var c = this;
                if (!c.IT) {
                    ...
                    a.l.Mt
                        ? this.nea(function(a, b) {
                              b
                                  ? this.Jaa(b, function(a, c) {
                                        a
                                            ? d(a)
                                            : (this.Xz(c),
                                              (this.wM = c),
            ...
            Ze: function(b, c) {
                ...
                f.TP(function(a) {
                    a
                        ? d(a)
                        : f.wM
                        ? ((a = f.MU(c, f.DK(f.fz, b), !0)),
                          f.wM.sendMessage(e.CO + ':injectCode', a, function(
                              a,
                              b
                          ) {
                              a || f.Xz(f.wM, h);
                ...
                if (!b.kX) {
                    ...
                    b.kX = setTimeout(function() {
                        ...
                        c.length &&
                            (d.Rv(
                                b,
                                1 === c.length ? c[0] : { ey: a.a.Ke(), Opa: c }
                            ),
                            (c.length = 0));
                    }, 0);
                }
            ...
            Jaa: function(a, b) {
                ...
                c.pfa(a);
                var d = this.x9(a);
                if (e.h9) b.call(c, null, { sendMessage: d });
                else {
                    e.h9 = !0;
                    var f = [
                        c.HU() + ':checkup',
        ...
        if (!g.xe) {
            ...
            b.send = function(b) {
                var c = d.nc + '://webapi.amap.com/count?',
                    k = g.extend(e({ J: a.rB[b.id].J }), b.params || {}),
                    l = g.a;
                b.params &&
                    b.params.rs &&
                    !b.params.type &&
                    ((b = a.rB[b.id].time), delete b.T0, (k = g.extend(k, b)));
                b = [];
                for (var m in k)
                    l.isArray(k[m])
                ...
                b.push('jl=' + (d.DB ? 1 : 0));
                if (
                    l.qj(window.performance, 'performance') &&
                    l.qj(window.performance.getEntriesByType, 'function')
                ) {
                    var n = 0,
                        p = [
                            'webapi.amap.com',
                            'jsapi-test.amap.test',
                            'localhost',
                        ],
                        q = ['/maps', '/css'];
                    l.Mb(
                    ...
                    function() {
                        return {
                            ...
                            Fra: function() {
                                this.hs > this.ZV &&
                                    this.EQ(
                                        Object.keys(this.cj).slice(
                                            0,
                                            Math.floor(this.ZV / 2)
                                        )
                                    );
                            },
                            EQ: function(a) {
                                ...
                                if (
                                    ...
                                    q.onreadystatechange = function() {
                                        if (
                                            ...
                                            if (3 === q.readyState) {
                                                var h = q.responseText.substring(
                                                    n
                                                );
                                                q.pp = e(h, q.pp);
                            ...
                            Ok: function(a, b) {
                                b(
                                    null,
                                    { yb: a, l1: !0, disabled: this.disabled },
                                    { hk: !0 }
                                );
                            },
                        };
    ...
    g.g = {
        ...
        xB: function(a, b, c) {
            return a.parentNode == b
                ...
                : a.parentNode &&
                  ...
                  !g.g.rm(a.parentNode, c)
                ? g.g.xB(a.parentNode, b)
                : !1;
        },
        Ow: function(a) {
            if (!a) return [0, 0];
            ...
            (b && c) ||
                !a.childNodes[0] ||
                ((b = b || a.childNodes[0].clientWidth),
        ...
        OZ: function() {
            document.selection &&
                ...
                document.selection.empty();
            this.uda ||
                ((this.uda = document.onselectstart),
        ...
        tR: function(a) {
            for (
                var b = document.documentElement.style, c = 0;
                c < a.length;
                c += 1
            )
        ...
        g4: function(a, b, c) {
            ...
            !c && g.l.oF
                ? ((b = g.g.g0(b)),
                  ...
                  1 < c.length
                      ? ((c[0] = b), (a.style[g.g.Pf] = c.join('rotate')))
                      : (a.style[g.g.Pf] = b),
                  g.l.c2 && (a.style.WebkitBackfaceVisibility = 'hidden'))
                : ((a.style.left = b.x + 'px'), (a.style.top = b.y + 'px'));
        },
        ne: function(a) {
            a.ri ||
                (a.ri = a.style.left
                    ? new g.G(parseInt(a.style.left), parseInt(a.style.top))
                    : new g.G(0, 0));
            return a.ri;
        },
        sza: function(a, b) {
        ...
        Z3: function(a, b) {
            ...
            return b.toLowerCase() !==
                a.style.cssText.replace(/ /g, '').toLowerCase()
                ? ((a.style.cssText = b), !0)
                : !1;
        },
        Ra: function(a, b) {
        ...
        rotate: function(a, b, c) {
            ...
            d
                ? ((a.style[d] = '' + (' rotate(' + b + 'deg)')),
                  (a.style[g.g.Hr[d] + '-origin'] = c.x + 'px ' + c.y + 'px'))
    ...
    g.g.Lta =
        'webkitTransition' === g.g.oD || 'OTransition' === g.g.oD
            ? g.g.oD + 'End'
            : 'transitionend';
    g.F = {
        h: function(a, b, c, d) {
        ...
        I: function(a, b, c, d) {
            ...
            !g.l.Wq ||
                ...
                (b = 'mouseover' === b ? 'mouseenter' : 'mouseleave');
            g.l.Z2 && -1 < b.indexOf('touch')
                ? this.spa(a, b, c)
                : g.l.of && 'dblclick' === b && this.opa
                ? this.opa(a, c)
        ...
        ll: function(a, b) {
            ...
            var c = document.body,
                ...
                c = new g.G(
                    g.l.of
                        ? a.pageX
                        : a.clientX + (c.scrollLeft || d.scrollLeft),
                    g.l.of ? a.pageY : a.clientY + (c.scrollTop || d.scrollTop)
                );
    ...
    (function() {
        ...
        g.extend(g.F, {
            dga: function(e, f) {
                if (!e.co)
                    if (((e.co = []), c))
                        (e.eo = e), e.attachEvent('onresize', a);
                    else {
            ...
            Pya: function(b, d) {
                ...
                b.co.length ||
                    (c
                        ...
                        : (b.eo.contentDocument.defaultView.removeEventListener(
                              'resize',
                              a
                          ),
    ...
    g.ob = {
        ...
        ds: function(a) {
            a =
                g.w.Kd +
                '/v3/log/init?' +
                ['s=rsv3&product=JsModule&key=' + g.w.key, 'm=' + a].join('&');
    ...
    window._jsload_ = function(a, b, c) {
        var d = g.ob.LA(a);
        d.dI &&
            0 <= g.a.indexOf(document.body.childNodes, d.dI) &&
            document.body.removeChild(d.dI);
        d.dI = null;
        try {
            if (!c && window.localStorage && b && '' !== b && g.l.fr) {
                var e = window.localStorage['_AMap_' + a],
                    e = e || '{}',
                    e = JSON.parse(e);
                e.version !== g.w.Si || e.script
                    ? window.localStorage.setItem(
                          '_AMap_' + a,
                          JSON.stringify({ version: g.w.Si, script: b })
                      )
                    : window.localStorage.setItem(
                          '_AMap_' + a,
                          JSON.stringify({
    ...
    window._cssload_ = function(a, b, c) {
        try {
            !c &&
                ...
                window.localStorage.setItem(
                    '_AMap_' + a,
                    JSON.stringify({ css: b, version: g.w.Si })
                );
        } catch (d) {}
        var e = document.createElement('style');
        e.type = 'text/css';
        -1 === g.w.tb.indexOf('webapi.amap.com') &&
            (b = b.replace(/webapi.amap.com/gi, g.w.tb.split('://')[1]));
    ...
    (function() {
        ...
        function h() {
            ...
            a &&
                (a.KI === u.data.KI && a.HY === u.data.HY ? (u.data = a) : e());
        }
        function k() {
            u.data = { KI: q.sf, HY: g.w.Si, keys: [], ef: {}, om: {} };
            u.Ir = {};
        }
        function l(a) {
        ...
        if (!g.Yi && q.di) {
            var s = g.indexedDB,
                u = { gJ: 1e3, key: '_AMap_data.tileKeys' },
                v = [],
                x = {
                    ...
                    setItem: function(a, b, c) {
                        ...
                        c &&
                            ...
                            1.5 < d.length / 1024 / 1024 &&
                                Object.keys(b.om).length &&
                                ((b.om = {}), (d = JSON.stringify(b))));
                        try {
            ...
            g.Yi = {
                ...
                get: function(c, d) {
                    function f(a) {
                        var b = { SO: l, b2: G, Wxa: x, ef: u.data.ef };
                        a &&
                            D.length &&
                            (/\|limg/.test(D[0])
                                ? (b.H1 = a
                    ...
                    c.qra.forEach(function(a) {
                        ...
                        k &&
                            ...
                            u.data.om[e] &&
                                (l.push(a),
                                D.push(e),
                                H.push({ data: p(u.data.om[e]), tileKey: e }),
                                (d = !0)));
                        d ||
                            (q.di && r.ga(u.data.keys, e)
                                ? (D.push(e), x.push(a))
                                : G.push(a));
                    });
                    ...
                    s.get(D, { timeout: c.timeout || 1e3 }, function(b, c) {
                        if (b || c.length !== D.length)
                            ...
                            if (k)
                                for (var d = c.length - 1; 0 <= d; d--) {
                                    var h = c[d];
                                    h && h.data
                                        ? (u.data.om[h.tileKey] = n(h.data))
                                        : G.push(x.splice(d, 1)[0]);
                                }
                            l = x;
                            x = [];
                            f(c);
                ...
                set: function(a, c) {
                    ...
                    u.data.ef = { 'x-vd-v': a['x-vd-v'], tv: a.tv, bgc: a.bgc };
                },
                flush: (function() {
                    var a = !0;
                    return function() {
                                  ...
                                  ? s.add(d, function(a) {
                                        a
                                            ? 3 !== a.code
                                                ? e()
                                                : (q.di = !1)
                                            : ((u.data.keys = u.data.keys.concat(
                                                  h
                                              )),
                                              x.setItem(u.key, u.data, !0),
                                              c());
    ...
    g.U = g.Z.extend({
        ...
        eb: function(a) {
            ...
            return a instanceof g.U
                ? 1e-9 >=
                      Math.max(Math.abs(this.Q - a.Q), Math.abs(this.R - a.R))
                : !1;
        },
        toString: function() {
    ...
    g.ue = g.Z.extend({
        r: function() {
            ...
            if (1 === arguments.length && arguments[0] instanceof Array)
                ...
                (a = g.a.Fa(arguments[0])), (b = g.a.Fa(arguments[1]));
        ...
        Rh: function() {
            return new g.U(
                this.oc.R > this.ac.R
                    ? ((this.oc.R + this.ac.R + 360) / 2) % 360
                    : (this.oc.R + this.ac.R) / 2,
        ...
        eb: function(a) {
            return a instanceof g.ue
                ? this.oc.eb(a.oc) && this.ac.eb(a.ac)
                : !1;
        },
        Ii: function() {
    ...
    g.G = g.Z.extend({
        ...
        at: function(a) {
            var b = this.length(),
                c = a.length();
            return b && c
                ? (180 * Math.acos((this.x * a.x + this.y * a.y) / c / b)) /
                      Math.PI
                : null;
        },
        nia: function(a) {
    ...
    g.gd.$c({ Ii: 'getWidth', Gi: 'getHeight', toString: 'toString' });
    g.Xn = g.Z.extend({
        r: function(a) {
        ...
        toBounds: function() {
            for (
                var a = new g.ue(180, 90, -180, -90), b = this.Qd.length - 1;
                0 <= b;
                b -= 1
            )
                a.extend(this.Qd[b]);
    ...
    g.Xn.$c({ contains: 'contains', Rh: 'getCenter' });
    g.k6 = g.Xn.extend({
        r: function(a) {
    ...
    g.df = g.Z.extend({
        r: function() {
            if (2 === arguments.length)
                (this.Sb = arguments[0]), (this.jd = arguments[1]);
            else if (
                ...
                throw 'Invalid Object: PixelBounds(' +
                    arguments.join(',') +
                    ')';
        },
        Rh: function(a) {
            return new g.G(
                (this.Sb.x + this.jd.x) / 2,
                (this.Sb.y + this.jd.y) / 2,
                a
            );
        },
        contains: function(a) {
            var b;
            a instanceof g.df ? ((b = a.Sb), (a = a.jd)) : (b = a);
            return (
                b.x > this.Sb.x &&
                a.x < this.jd.x &&
                b.y > this.Sb.y &&
    ...
    g.pD = g.Z.extend({
        ...
        jsa: function(a, b) {
            b = b || 1;
            return new g.G(
                (a.x / b - this.wT) / this.hT,
                (a.y / b - this.eU) / this.KT
            );
        },
    });
    g.bo = g.Z.extend({
        r: function(a) {
            ...
            a.project &&
                a.unproject &&
                ((this.Yb = a.project), (this.wh = a.unproject));
        },
    });
    g.bo.GS = {
        Yb: function(a) {
    ...
    g.yh.Hta = g.extend({}, g.yh.XC, { lf: g.bo.GS, HC: new g.pD(1, 0, 1, 0) });
    g.fH = {
        Yb: function(a, b) {
            a = g.a.Fa(a);
        ...
        oua: function(a) {
            return new g.G(
                a.x + 2.0037508342789244e7,
                2.0037508342789244e7 - a.y
            ).Uc(0.14929107086948487);
        },
        G2: function(a) {
            return new g.G(
    ...
    z.Db = g.Z.extend({
        ...
        setLang: function(a) {
            ...
            ('en' !== a && 'zh_cn' !== a && 'zh_en' !== a) ||
                ...
                (this.set('lang', a), this.oj && this.oj.I3(this));
        },
        getLang: function() {
        ...
        getCity: function(a, b) {
            ...
            new g.bb.qb(c, { callback: 'callback', lw: !0, Cc: 'REGEO' }).h(
                'complete',
                function(b) {
        ...
        r: function(a, b) {
            ...
            b.maxPitch &&
                (b.maxPitch = Math.min(
                    this.D.maxPitch,
                    Math.max(b.maxPitch, 0)
                ));
            b.pitch &&
                (b.pitch = Math.min(
                    b.maxPitch || this.D.maxPitch,
                    Math.max(b.pitch, 0)
                ));
            ...
            g.xe.Re.start({ id: this.id, J: this.J });
            this.J.KJ = this;
            ...
            this.YM();
            var e = this;
            this.eg({ overlays: [], infos: {}, controls: {} });
            var f = [];
            ...
            '3D' === b.viewMode && g.l.Ap
                ? f.push('Map3D')
                : g.l.lk && f.push('cmng', 'labelcanvas');
            ...
            this.Fma(function() {
                g.ob.Vg(f, function() {
                    if (!e.get('destroy')) {
                        ...
                        '3D' === e.view.type &&
                            (e.AmbientLight ||
                                (e.AmbientLight = new g.$u.gS([1, 1, 1], 0.9)),
                            e.DirectionLight ||
                                (e.DirectionLight = new g.$u.oS(
                                    [0, -1, 1],
                                    [1, 1, 1],
                                    0.1
                                )));
            ...
            if ((a = new g.ue(a[0], a[1], a[2], a[3])) && b && d) {
                for (var e = c[1]; e > c[0]; e -= 1) {
                    var f = this.Yb(a.oc, e),
                        h = this.Yb(a.ac, e);
                    if (
                        Math.abs(h.x - f.x) < b.width &&
                        Math.abs(f.y - h.y) < b.height
                    )
                        break;
                }
        ...
        mia: function(a) {
            '3D' === this.get('viewMode') && g.l.Ap
                ? (this.set('baseRender', 'vw'),
                  (this.view = new g.zJ(this, a)))
                : (this.view = new g.sD(this, a));
            this.M0();
        },
        M0: function() {
                ...
                if (a && !('dv' < a)) {
                    ...
                    b &&
                        ...
                        (d ||
                            ...
                            ? (this.set('baseRender', 'v'), (this.$P = a))
                            : this.$P &&
                              (this.set('baseRender', this.$P),
                              (this.$P = null)));
                    this.M0();
                }
            }
        ...
        Vfa: function() {
            ...
            !a.rl &&
                a.J &&
                ((a.indoorMap = a.rl = new AMap.IndoorMap({ innerLayer: !0 })),
                a.hR(),
                g.a.Fc(function() {
            ...
            0 <= g.a.indexOf(b, a) ||
                (a instanceof z.A.Lm
                    ? (this.get('overlays').push(a),
                      this.tw instanceof z.A.Lm &&
                          ((this.tw.B = !0), this.tw.close(), (this.tw.B = !1)),
                      (this.tw = a),
                      this.set('contextmenu', a, !0))
                    : (a instanceof z.A.Ge &&
                          (this.sl instanceof z.A.Ge && this.Jx(this.sl),
                          (this.sl = a)),
                      this.get('overlays').push(a)),
                this.q('overlays'));
        },
        ...
        getZoom: function() {
            ...
            return this.bB(
                this.get('targetLevel') || this.get('zoom', null, !0)
            );
        },
        getCenter: function() {
        ...
        setCenter: function(a, b) {
            ...
            b || !this.loaded
                ? (this.q('movestart'),
                  this.set('center', a),
                  this.q('mapmove'),
                  this.map ? this.map.q('moveend') : this.q('moveend'))
                : ((this.B = !0), this.panTo(a), (this.B = !1));
        },
        ...
        getStatus: function() {
            ...
            for (
                var a = 'isHotspot pitchEnable dragEnable zoomEnable keyboardEnable jogEnable doubleClickZoom scrollWheel resizeEnable touchZoom rotateEnable animateEnable'.split(
                        ' '
                    ),
                    b = {},
                    c = 0;
        ...
        getDefaultCursor: function() {
            ...
            return (
                ...
                'url(' + g.w.tb + '/theme/v1.3/openhand.cur),default'
            );
        },
        ...
        clearControl: function() {
            ...
            a.xd = a.xd || {};
            for (var b in a.xd)
                a.xd.hasOwnProperty(b) &&
                    (a.remove.push(a.xd[b]), delete a.xd[b]);
            this.set('controls', a);
        },
        plugin: function(a, b) {
            g.c.add(this, 'setPitch');
        ...
        clearInfoWindow: function() {
            ...
            a &&
                0 !== a.length &&
                this.sl &&
                ((this.sl.B = !0), this.sl.close(), (this.sl.B = !1));
        },
        remove: function(a) {
            g.c.add(this, 'remove');
        ...
        getSize: function() {
            ...
            (!this.JD || 10 > this.JD.width * this.JD.height) &&
                this.refreshSize();
            return this.JD;
        },
        ...
        panTo: function(a) {
            ...
            this.loaded
                ? this.set('panTo', a)
                : ((this.B = !0), this.setCenter(a), (this.B = !1));
        },
        panBy: function(a, b, c) {
            ...
            b =
                this.loaded && this.map && this.map.nd
                    ? this.map.nd.J4
        ...
        setFitView: function(a, b, c, d) {
            ...
            if ((a = this.S_(a))) {
                if ((c = this.sG(a, 0, new g.G(40, 40), c, d)))
                    (b =
                        b ||
                        !this.getBounds().contains(a.Rh()) ||
                        (g.l.Y &&
                            1 < Math.abs(c[0] + this.get('zoom', null, !0)))),
        ...
        S_: function(a) {
            ...
            if (a) {
                for (var b, c = 0; c < a.length; c += 1) {
                    ...
                    if (
                        d.get('visible') &&
                        !(d instanceof z.A.Ge || d instanceof z.A.Lm)
                    ) {
                        d.B = !0;
                        var e = d.getBounds();
                        d.B = !1;
        ...
        setBounds: function(a, b, c, d, e, f) {
            ...
            d =
                d ||
                (g.l.Y && 1 < Math.abs(c[0] + b - this.get('zoom', null, !0)));
            this.B = !0;
        ...
        drawPolyline: function(a) {
            ...
            this.set('drawStyle', a || { strokeColor: '#006600', hb: 0.9 });
        },
        render: function(a) {
            g.c.add(this, 'render');
    ...
    z.Db.ub({
        isHotspotChanged: function() {
            if (
                'undefined' !== typeof this.lB &&
                (this.Fha(), this.get('isHotspot'))
            ) {
    ...
    z.event = {
        ...
        addListener: function(a, b, c, d) {
            g.a.Vh(a.addListener)
                ? a.addListener(b, c, d)
                : (a.ae || (a.ae = g.na.ae), g.na.h.call(a, b, c, d));
            return new g.ZC(1, a, b, c, d);
        },
        fw: function(a, b, c, d) {
            g.a.Vh(a.fw)
                ? a.fw(b, c, d)
                : (a.ae || (a.ae = g.na.ae), g.na.h.call(a, b, c, d, !0));
            return new g.ZC(1, a, b, c, d);
        },
        DF: function(a) {
        ...
        removeListener: function(a) {
            a instanceof g.ZC &&
                (g.a.Vh(a.Ji.removeListener)
                    ? a.Ji.removeListener(a)
                    : 0 === a.type
                    ? g.F.I(a.Ji, a.IN, a.MO, a.ff)
                    : 1 === a.type &&
                      (a.Ji.ae || (a.Ji.ae = g.na.ae),
        ...
        M: function(a, b) {
            ...
            g.a.Vh(a.M)
                ? a.M.apply(a, c)
                : (a.ae || (a.ae = g.na.ae), g.na.q.apply(a, c));
        },
    };
    g.ZC = g.Z.extend({
    ...
    z.o.Hc = g.Z.extend({
        ...
        r: function(a) {
            ...
            g.a.Ib(this, a);
            this.D.map &&
                ((a = this.D.map), delete this.D.map, (this.D.map = a));
            this.eg(this.D);
        },
        getContainer: function() {
            g.c.add(this, 'getContainer');
        ...
        setMap: function(a) {
            ...
            var b = this.get('map');
            a
                ? (b && a !== b && b.Bj(this), this.set('map', a))
                : b &&
                  (b.Bj(this),
                  this.set('map', null, !0),
                  (this.vi = !1),
    ...
    z.o.gb = z.o.Hc.extend({
        ...
        r: function(a) {
            ...
            var b = a.zooms;
            b && b[1] >= this.rk[0]
                ? (b[0] < this.rk[0] && (b[0] = this.rk[0]),
                  b[1] > this.rk[1] && (b[1] = this.rk[1]))
        ...
        kZ: function() {
            if (!this.Jt()) return !1;
            var a = this.get('map');
            return a && a.Wh && 'zh_cn' === a.get('lang') && !this.noVector
                ? !0
                : !1;
        },
        Y_: function(a) {
            ...
            if (b)
                if (((this.ip = !0), g.o.Eh)) {
                    if (
                        ...
                        b &&
                            ((d.yk = new g.o.pd(
                                new z.o.gb({ zooms: [16, 20], innerLayer: !0 }),
                                a,
                                ['building']
                            )),
                            (d.yk.type = '\u697c\u5757\u56fe\u5c42'),
                        ...
                        return (
                            '3D' == a.C.view.type
                                ? ((c = new g.o.pd(this, a, [
                                  ...
                                  (c.yk.Zw = 1),
                                  c.yk.Ie(
                                      ['visible', 'merge', 'sort', 'opacity'],
                                      c,
                                      !0
                                  ),
                                  b.W('rejectMapMask', this, !0))
                                : ((c = new g.o.pd(this, a, [
                                      'region',
                                      'building',
                                      'road',
        ...
        getTiles: function() {
            ...
            for (var b = [], c, d = 0; d < a.length; d += 1)
                a[d].key &&
                    ((c = a[d].key.split('/')), b.push('' + c[1] + ',' + c[2]));
            return b;
        },
        reload: function() {
            g.c.add(this, 'reload');
        ...
        Up: function(a) {
            ...
            return function(f, h, k) {
                ...
                e &&
                    e.length &&
                    (k = k.replace(d, e[Math.abs(f + h) % e.length]));
                return k;
            };
        },
    ...
    z.o.gb.LS = z.o.gb.extend({
        ...
        Ng: function(a) {
            if (this.get('map').Wh) {
                ...
                g.l.ha &&
                    this.get('detectRetina') &&
                    (b = g.w.ZH.replace('scl=1', 'scl=2'));
                a = new g.o.gb(this, a, this.Up(b), this.D.maxDataZoom);
            } else (this.ip = !1), (a = new g.o.gb(this, a));
            return a;
        },
    });
    z.o.gb.RS = z.o.gb.extend({
        ...
        wg: function() {
            ...
            this.stopRefresh();
            this.get('map') &&
                this.get('map').I('zoomstart', this.reload, this);
            this.B = !1;
        },
        Ng: function(a) {
            var b = this.get('map'),
            ...
            return 'd' !== b.get('baseRender')
                ? g.o.hv
                    ? (a = new g.o.hv(this, a))
                    : ['vt']
                : (a = new g.o.gb(this, a, null, this.D.maxDataZoom));
        },
    });
    ...
    z.o.gb.Yu = z.o.gb.Iy.extend({
        D: { detectRetina: !0, zooms: [10, 18], zIndex: 2 },
        r: function(a) {
            arguments.callee.ka.apply(this, arguments);
            var b = this;
            this.set('createTile', function(a, d, e, f, h) {
    ...
    z.o.d6 = z.o.Hc.extend({
        D: { zooms: [14, 20], zIndex: 8, visible: !0, merge: !0, sort: !1 },
        r: function(a) {
    ...
    z.o.Q6 = z.o.Hc.extend({
        ...
        r: function(a, b) {
            ...
            g.l.lk &&
                ...
                g.a.Ib(this, b),
                b.style
                    ? (this.eg(this.D, !0), this.setStyle(b.style))
                    : this.setStyle(this.D),
                (this.B = !1));
        },
        clear: function() {
            g.c.add(this, 'clear');
            ...
            if (a instanceof Array) {
                for (var b = 0; b < a.length; b += 1)
                    (a[b].rotation_ = (Math.PI * (a[b].rotation || 0)) / 180),
                        ...
                        (a.af = Math.max(
                            a.af || 0,
                            a[b].size.width + a[b].anchor.x
                        )),
                        (a.If = Math.max(
                            a.af || 0,
                            a[b].size.height + a[b].anchor.y
                        ));
                this.Bl = a;
            } else
        ...
        setMap: function(a) {
            ...
            g.l.lk &&
                (a
                    ? (this.get('map') && this.get('map').Bj(this),
                      this.set('map', a))
                    : this.get('map') &&
                      (this.get('map').Bj(this),
                      this.set('map', null, !0),
                      (this.vi = !1),
                      this.wg && this.wg()));
        },
        Ng: function(a) {
            return g.ob.yB(['cvector'])
                ? ((a = new g.o.Qc(this, a)), this.W('datas', a), a)
                : ['cvector'];
        },
    });
    z.o.aJ = z.o.Ly.extend({
        ...
        Gna: function(a) {
            this.get('bounds').contains(a.lnglat) &&
                ((a.target = this), this.q('click', a));
        },
        Hna: function(a) {
            this.get('bounds').contains(a.lnglat) &&
                ((a.target = this), this.q('dblclick', a));
        },
        setMap: function(a) {
            g.c.add(this, 'setMap');
            a
                ? (this.get('map') &&
                  ...
                  this.set('map', a))
                : this.get('map') &&
                  (this.get('map').Bj(this), (this.he.map = null));
        },
        mapChanged: function() {
            this.get('map') &&
                (this.get('map').mF(this),
                this.get('clickable') &&
                    ((this.sZ = z.event.addListener(
                        this.get('map'),
                        'click',
                        this.Gna,
                        this
                    )),
                    (this.JZ = z.event.addListener(
                        this.get('map'),
                        'dblclick',
                        this.Hna,
                        this
    ...
    z.A.Dh = g.Z.extend({
        ga: [g.na, g.He, { Fa: g.a.Fa }],
        D: { extData: {}, bubble: !1, clickable: !0, draggable: !1 },
        r: function() {
            this.nE = g.a.Bb(this);
        },
        Mwa: function() {
    ...
    z.A.lD = z.A.Qc.extend({
        ...
        getPath: function() {
            ...
            this.A &&
                this.A.get('deltaPos') &&
                (a = this.A.GK(a, this.A.get('deltaPos')));
            return a;
        },
        bd: function() {
            var a = this.get('path');
            ...
            for (
                var b = new g.ue(180, 90, -180, -90), c = 0;
                c < a.length;
                c += 1
            )
    ...
    z.A.lb = z.A.Dh.extend({
        ...
        moveTo: function(a, b, c) {
            g.c.add(this, 'moveTo');
            a = this.Fa(a);
            this.set('move', { cg: a, speed: b, rb: c });
        },
        moveAlong: function(a, b, c, d) {
            ...
            if (!(2 > a.length)) {
                ...
                for (var e = [a[0]], f = a[0], h = 1; h < a.length; h += 1)
                    f.eb(a[h]) || e.push(a[h]);
                this.set('move', { cg: e, speed: b, rb: c, uha: d });
            }
        },
        stopMove: function() {
    ...
    z.A.Lm = z.A.Dh.extend({
        ...
        addItem: function(a, b, c) {
            ...
            this.get('items').push({ m5: a, rb: b, xH: c });
            this.q('items');
        },
        ...
        open: function(a, b) {
            ...
            this.map
                ? this.map &&
                  this.map !== a &&
                  (this.map.Jx(this), (this.map = a), this.setMap(a))
        ...
        close: function() {
            ...
            this.setMap(null);
            this.map &&
                ((this.map = this.map.tw = null),
                this.q('close', { type: 'close', target: this }));
            this.B = !1;
        },
    });
    ...
    (function(a) {
        ...
        function h(b, f, h, n, p, q) {
            ...
            if (b && h && h.length) {
                ...
                h = a.extend(
                    { tolerance: 4, interpolateNumLimit: [3, 300] },
                    q
                );
                q = h.tolerance;
        ...
        a.Tu = {
            ...
            YF: (function() {
                ...
                return function(e, f, h, s) {
                    ...
                    if (e === f && h === s) return b;
                    for (
                        var x = d ? new Float32Array(11) : Array(11), t = 0;
                        11 > t;
                        ++t
                    )
                        x[t] = a(0.1 * t, e, h);
            ...
            N_: function(a, b, c, d) {
                ...
                for (f = a.length; e < f; e += 1)
                    r.push.apply(
                        r,
                        h(a[e - 1], a[e], a[e].controlPoints, b, c, d)
                    );
                return r;
            },
    ...
    z.A.By = z.A.Qb.extend({
        D: { tolerance: 4, interpolateNumLimit: [3, 300] },
        r: function(a) {
        ...
        Qda: function(a) {
            ...
            if (a instanceof g.U) b = a;
                ...
                if ('string' === b || 'number' === b) {
                    ...
                    if (d % 2)
                        throw Error(
                            "LngLat number should be even, now it's " + d
                        );
    ...
    z.A.tc = z.A.lD.extend({
        r: function(a) {
            ...
            g.a.Ib(
                this,
                g.extend({ fillColor: '#FFAA00', fillOpacity: 0.9 }, a)
            );
            this.setOptions(this.D);
            this.B = !1;
        },
    ...
    z.A.Eg = z.A.Qc.extend({
        ...
        getCenter: function() {
            ...
            this.A &&
                this.A.get('deltaPos') &&
                (a = this.A.GK([a], this.A.get('deltaPos'))[0]);
            return a;
        },
    ...
    var qc = g.Z.extend({
        r: function(a) {
            ...
            c =
                a instanceof Array
                    ? a
                    : a instanceof g.Jk || a instanceof g.La
                    ? a.elements
                    : arguments;
            b[0] = c[0] || 0;
            b[1] = c[1] || 0;
    ...
    z.A.Tr = z.A.tc.extend({
        ...
        mapChanged: function() {
            ...
            !this.rg &&
                this.get('map') &&
                ((this.rg = !0), this.get('map').q('overlays'));
        },
        setCenter: function(a, b) {
            g.c.add(this, 'setCenter');
            (a = g.a.Fa(a)) &&
        ...
        getCenter: function() {
            ...
            this.A &&
                this.A.get('deltaPos') &&
                this.A.GK([a], this.A.get('deltaPos'))[0];
            return a;
        },
    });
        ...
        function c(a, b) {
            ...
            for (var c = 0, d = a.length; c < d; c++) {
                ...
                if (
                    !(
                        '*' === b ||
                        (e && e.geometry && e.geometry.type === b)
                    ) ||
                ...
                this.D = b.extend(
                    {
                        ...
                        getPolyline: function(b, c) {
                            return new a.A.Qb({ path: c, innerOverlay: !0 });
                        },
                        getPolygon: function(b, c) {
                            return new a.A.tc({ path: c, innerOverlay: !0 });
                        },
                ...
                if (b)
                    switch (b.type) {
                        ...
                        case 'FeatureCollection':
                            for (
                                var c = b.features, d = [], e = 0, m = c.length;
                                e < m;
                                e++
                            ) {
                                var n = this.OK(c[e]);
            ...
            toGeoJSON: function(a) {
                ...
                if (c(e, 'Point'))
                    ...
                    e = {
                        type: 'Feature',
                        properties: a,
                        geometry: { type: 'GeometryCollection', geometries: k },
                    };
                } else
                    e = {
    ...
    g.ed = {
        Hq: function(a, b) {
            for (
                var c = Infinity, d = 0, e = 1, f = b.length;
                e < f;
                d = e, e += 1
            )
    ...
    (function(a) {
        ...
        a.extend(e.prototype, {
            ...
            isPoint: function(b) {
                return (
                    b && (b instanceof a.U || (a.a.isArray(b) && !isNaN(b[0])))
                );
            },
            normalizePoint: function(a) {
                return a;
            ...
            Jv: function(a, b) {
                ...
                !0 === b
                    ...
                    : !1 === b &&
                      ((c = this.makesureClockwise(c)), c.reverse());
                return c;
            },
            sea: function(a) {
                for (var b = [], c = 0, d = a.length; c < d; c++)
            ...
            isPointInPolygon: function(a, b) {
                ...
                for (
                    var c, d = 0, e = b.length;
                    d < e &&
                    ((c = this.isPointInRing(a, b[d])), 0 < d && (c = !c), c);
                    d += 1
                );
                return c;
            },
    ...
    (function(a) {
        a.rS = function() {
            ...
            function d(a, b, e, f, r, u, B) {
                if (a) {
                    ...
                    for (F = a; a.Ba !== a.next; ) {
                        ...
                        G = a.next;
                        if (u)
                            a: if (((H = a.Ba), (J = a.next), 0 <= l(H, a, J)))
                                H = !1;
                            else {
                                L = h(
                                    H.x < a.x
            ...
            function f(a, b) {
                ...
                do {
                    if (e <= c.y && e >= c.next.y && c.next.y !== c.y) {
                        var l =
                            c.x +
                            ((e - c.y) * (c.next.x - c.x)) / (c.next.y - c.y);
                        if (l <= d && l > f) {
                            f = l;
                            if (l === d) {
                                if (e === c.y) return c;
            ...
            function p(a, b) {
                return 0 > l(a.Ba, a, a.next)
                    ? 0 <= l(a, b, a.next) && 0 <= l(a, a.Ba, b)
                    : 0 > l(a, b, a.Ba) || 0 > l(a, a.next, b);
            }
            function q(a, b) {
    ...
    for (
        var $ = {
            ...
            vc = 'addDomListener addDomListenerOnce addListener addListenerOnce clearInstanceListeners clearListeners removeListener trigger'.split(
                ' '
            ),
            wc = 0;
        wc < vc.length;
    ...
    for (wc in yc)
        yc.hasOwnProperty(wc) &&
            'function' == typeof yc[wc] &&
            ($.Util[wc] = (function() {
                var a = wc;
                return function() {
                    g.c.qa($.Util);
    ...
    for (wc in zc)
        zc.hasOwnProperty(wc) &&
            'function' == typeof zc[wc] &&
            ($.DomUtil[wc] = (function() {
                var a = wc;
                return function() {
                    g.c.qa($.DomUtil);
    ...
    if (!Ac.DB && 'undefined' !== typeof arguments && arguments.callee)
        try {
            if (g.l.fr && window.localStorage) {
                ...
                (Bc && JSON.parse(Bc).version === Ac.Si) ||
                    window.localStorage.setItem(
                        '_AMap_' + g.mH,
                        JSON.stringify({
                            version: Ac.Si,
                ...
                k.onreadystatechange = function() {
                    4 === k.readyState && 200 === k.status
                        ? f.q('complete', {
                              url: a,
                              data:
                                  'arraybuffer' === k.responseType
                                      ? k.response
                                      : k.responseText,
                          })
                        : 404 === k.status &&
                          (k.abort(), f.q('error', { url: a, data: '404' }));
                };
    ...
    g.Db = g.Z.extend({
        ...
        r: function(a, b) {
            ...
            this.W('draw', b);
            this.Ie(
                'zoomAndCenter destroy defaultCursor jogEnable animateEnable baseRender overlayRender gridMapForeign vectorMapForeign'.split(
                    ' '
                ),
                b
            );
        ...
        SL: function() {
            ...
            b &&
                ...
                this.set('display'),
                this.H3(b),
                this.get('resizeEnable') &&
                    this.ja('resize', { vna: a, k2: b }));
        },
        gX: function() {
            var a = this;
            a.SL();
        ...
        Ela: function() {
            ...
            -1 === c.indexOf('amap.com') &&
                -1 === c.indexOf('gaode.com') &&
                ((b.Pt.href = g.l.Y ? 'http://m.amap.com' : 'http://gaode.com'),
                (b.Pt.target = '_blank'));
            g.g.create('img', b.Pt).src = g.l.md
                ? this.C.D.logoUrlRetina
                : this.C.D.logoUrl;
            b.km = g.g.create('div', a, 'amap-copyright');
            b.km.style.display = 'none';
            350 < g.g.DG(this.J).width &&
                ((b.km.innerHTML = this.C.D.copyright),
        ...
        Xp: function() {
                ...
                for (
                    ...
                    if (
                        !(
                            ...
                            b < e[0] ||
                            !a[c].get('visible') ||
                            (a[c].o && a[c].o.ma && 0 === a[c].o.ma.length) ||
                            (a[c].o && a[c].o.OB) ||
                            (a[c].o && a[c].o.Ha)
                        )
                    )
            ...
            function b() {
                var a = { id: d.C.id };
                g.xe.Re.end(g.extend(a, { key: 'rds' }));
                g.xe.Re.send(
                    g.extend(a, {
                        params: {
                            rs: d.get('baseRender'),
            ...
            if (!this.oN)
                if (this.BB)
                    ...
                    var d = this,
                        ...
                        f = a();
                    e
                        ? (e.o && e.o.Ha && (this.C.Ha || c()),
                          f && (this.C.Ha || c(), this.x3(), b()))
                        : f && (this.C.Ha || c(), b(), (this.C.n3 = !0));
                }
        },
        layersChanged: function() {
            this.ta = this.ta || [];
            for (
                var a = this.get('layers'), b = this.ta.length - 1;
                0 <= b;
                b -= 1
            )
                this.ta[b] === this.zd ||
            ...
            c && this.C.get('showLabel')
                ? (-1 === a && this.ta.push(this.Jc),
                  (this.Jc.ha = d && g.l.ha),
                  this.Jc.zA(this.get('mapStyle') || 'normal'),
                  this.Jc.set('zIndex', e),
                  this.Jc.set('visible', !0),
                  (this.C.lB = !0),
                  this.C.get('isHotspot') ? this.Jc.Pna() : this.Jc.cN())
                : (this.Jc &&
                      (this.Jc.set('visible', !1),
                      (this.C.lB = !1),
                      this.Jc.cN()),
                  (this.C.lB = !1));
        ...
        controlsChanged: function() {
            ...
            if (a.add && 0 < a.add.length)
                for (; 0 < a.add.length; )
                    (b = a.add.shift()),
                        (c = b.Os || b.addTo) &&
                            c.call(b, this.C, this.Pa.controls);
        ...
        mY: function() {
            if (!this.oN) {
                ...
                a.zd ||
                    ...
                    (a.zd.SA = !0));
                for (
                    var b = a.get('overlays'), c = [], d = 0;
                    d < a.Pc.length;
                    d += 1
                )
                    -1 === g.a.indexOf(b, a.Pc[d].Wb) &&
                        (a.Pc[d].Wb instanceof z.A.Ge ||
                        a.Pc[d].Wb instanceof z.A.Lm
                            ? a.Pc[d].wg()
                            : (a.zd && a.Pc[d] instanceof g.A.lb
                                  ? ((a.zd.ug = g.a.Bw(a.zd.ug, a.Pc[d].L)),
                                    a.zd.t3([a.Pc[d].L]))
                                  : a.rr && a.rr.t3([a.Pc[d].L]),
                              a.Pc[d].L.ca
                                  ? (g.g.remove(a.Pc[d].L.ca),
                                    (a.Pc[d].L.ca = null))
                                  : a.Pc[d].L.Ta &&
                                    (g.g.remove(a.Pc[d].L.Ta.Ef),
                ...
                g.a.iqa(function(b) {
                    if (!b.vi && b.rg) {
                        ...
                        c &&
                            (a.Pc.push(c),
                            c instanceof g.A.Ge || c instanceof g.A.Lm
                                ? c.wx(a)
                                : c instanceof g.A.lb
                                ? e.push(c.L)
                                : f.push(c.L),
        ...
        overlaysChanged: function() {
            ...
            this.get('overlays') && 0 === this.get('overlays').length
                ? this.mY()
                : this.rY || (g.a.Fc(this.mY, this), (this.rY = !0));
        },
        ...
        Sga: function(a) {
            ...
            if (a instanceof z.A.lb) b = new g.A.lb(a, this);
                ...
                a instanceof z.A.tc
                    ...
                    : a instanceof z.A.Tr
                    ? (b = new g.A.tc(a, this))
                    : a instanceof z.A.Yr && (b = new g.A.tc(a, this));
            }
            return b;
        },
        x_: function() {
            ...
            this.dt &&
                (a =
                    'function' === typeof this.dt
                        ? this.dt(this.hf.P.zoom)
                        : this.dt);
            return a;
        },
        hva: function() {
        ...
        bc: function() {
            ...
            if (!this.oN) {
                ...
                if (
                    this.ta &&
                    ((a.size = this.C.get('size')),
                    a.size.width && a.size.height)
                ) {
                    for (
                        var b = this.C.view.type,
                            c = [],
                            d = 0,
                            e = this.ta.length;
                        d < e;
                    ...
                    for (
                        ...
                        this.ta[d].Li &&
                            this.ta[d].X.get('visible') &&
                            a.P.zoom <= this.ta[d].X.get('zooms')[1] &&
                            (a.JQ = !0),
                            this.ta[d].nl().md && (b = !0);
                    ...
                    a.Hd = this.Hd;
                    if ((f = this.uG())) f.bc(a), (this.ul = this.t_ = !1);
                }
            }
        },
        uG: function() {
        ...
        destroyChanged: function() {
            ...
            this.T = {};
            this.Jc &&
                (this.Jc.X.I('complete', this.Xp, this),
                this.Jc.wg(),
        ...
        drawChanged: function() {
            ...
            if (d) {
                ...
                g.ob.load('interaction', function() {
                    var b = new g.tta({ type: d, o: a.rr }, a);
                    a.Zo.push(b);
                    a.loaded = !0;
                });
            } else if (this.Zo)
                for (b = 0, c = this.Zo.length; b < c; b += 1)
                    this.Zo[b].ppa(),
                        this.Zo[b].Bva(),
                        ...
                        for (
                            ...
                            if ('CANVAS' === v.tagName || 'IMG' === v.tagName)
                                (h = parseFloat(v.style.top) || 0),
                                    ...
                                    (q =
                                        parseFloat(v.style.height) || v.height),
    ...
    g.Db.ub({
        ...
        rotateEnableChanged: function() {
            ...
            g.l.of &&
                this.QY &&
                '3D' !== this.C.view.type &&
                (this.Zpa ? this.QY() : this.una());
        },
        zoomEnableChanged: function() {
            this.get('zoomEnable')
                ? (g.l.of && this.KM && '3D' !== this.C.view.type && this.KM(),
                  g.l.Y || this.t8())
                : (g.l.of && this.OP && this.OP(), g.l.Y || this.Nba());
        },
        ...
        ai: function(a, b, c, d) {
            ...
            g.l.of &&
                ('touchend' !== a.type ? (this.T.fba = h) : (h = this.T.fba));
            f.vb = h;
            f.Ka = this.Xf(h);
        ...
        OL: function() {
            var a = this.T;
            a.Ff &&
                (a.kj.vb.x === a.Ff.x && a.kj.vb.y === a.Ff.y
                    ? (a.lg = !1)
                    : ((a.lg = !0),
                      a.jo || (a.No.q('dragstart', a.Mo), (a.jo = !0)),
    ...
    g.Db.ub({
        ...
        A2: function() {
            2 !== this.js &&
                12 === this.get('zoom') &&
                ((this.js = 1), g.a.dB.start(this.WD));
            this.bk = !0;
        },
        z2: function() {
            1 === this.js &&
                13 !== this.get('zoom') &&
                ((this.js = 0), g.a.dB.cancel(this.WD));
            this.bk = !1;
            this.set('display');
        },
        LX: function(a, b) {
        ...
        u2: function(a) {
            ...
            this.Gs();
            this.H3();
            !a.j1 && this.C.get('limitBounds', null, !0)
                ? (a = this.kha()) && !a.eb(this.get('center'))
                    ? this.gI(this.get('zoom'), a, !1, !0)
                    : this.ja('moveend')
                : this.ja('moveend');
            this.set('display');
        },
        ...
        ja: function(a, b) {
            if (this.C.ae(a)) {
                ...
                b &&
                    (c = b.k2
                        ? { type: a, newsize: b.k2, oldsize: b.vna }
                        : {
                              type: a,
                              pixel: b.vb,
                              target: this.C,
        ...
        CE: function(a, b) {
            var c = this.get('targetLevel') || this.get('zoom'),
                ...
                c = Math.min(
                    Math.max(c, this.get('zooms')[0]),
                    this.get('zooms')[1]
                );
            c === this.get('zoom') ||
                (this.tf && this.tf.ju && c === this.tf.end) ||
                this.zy(c, !1, a);
        },
        rW: function(a) {
            this.ja('click', a);
        ...
        OJ: function() {
            this.VA &&
                ('3D' === this.C.view.type
                    ? (this.h('dragstart', this.BW),
                      this.h('dragging', this.xW),
                      this.h('dragend', this.zW))
                    : (this.h('dragstart', this.AW),
        ...
        wL: function() {
            this.VA ||
                ('3D' === this.C.view.type
                    ? (this.I('dragstart', this.BW),
                      this.I('dragging', this.xW),
                      this.I('dragend', this.zW))
                    : (this.I('dragstart', this.AW),
        ...
        wW: function() {
            ...
            if (c || b) {
                ...
                (d = this.mZ(a)) &&
                    (c = Math.round(this.De(d).Wa(this.De(a)).y));
                ...
                if (this.T.lg) {
                    ...
                    this.pe.kp = function(a) {
                        if (2 > Math.abs(a.x) && 2 > Math.abs(a.y))
                            ...
                            b = this.get('centerCoords').Wa(
                                new g.G(b, e).Jd(this.S)
                            );
                            e = this.mZ(b);
                            f = a.y;
                    ...
                    this.q('moveend'), this.Mq(!0), (this.ps = this.Hg = null);
        ...
        bS: function() {
            if (g.l.$k && (g.l.EI || g.l.qF)) {
                for (
                    var a = this.Pa.o.childNodes, b = 0;
                    b < a.length;
                    b += 1
                ) {
                    var c = a[b];
        ...
        Mq: function(a) {
            this.T.refresh &&
                (clearInterval(this.T.refresh), (this.T.refresh = null));
    ...
    g.TS = g.Z.extend({
        ...
        Uha: function() {
            ...
            if (this.get('center') instanceof g.U) {
                ...
                a = this.map.Rb(a.wn());
                this.GJ = { Bc: b.x, $b: b.y, Ac: a.x, rc: a.y };
            } else
                (a = this.map.get('limitBounds', null, !0)),
                    (this.GJ = { Bc: a[0], $b: a[1], Ac: a[2], rc: a[3] });
        },
        CG: function() {
            var a = this.map,
                b = this.get('zoom');
        ...
        centerChanged: function() {
            this.set(
                'centerCoords',
                this.map.Rb(this.get('center')).toFixed(3),
                !0
            );
        },
        centerCoordsChanged: function() {
    ...
    g.sD = g.TS.extend({
        jl: function() {
            var a = this.get('size'),
                ...
                c = (Math.PI * c) / 180,
                a = new g.G(
                    (Math.abs(a.width * Math.cos(c)) +
                        Math.abs(a.height * Math.sin(c))) /
                        2,
                    (Math.abs(a.width * Math.sin(c)) +
                        Math.abs(a.height * Math.cos(c))) /
                        2
                ),
        ...
        Sja: function(a) {
            var b = this.get('size'),
                ...
                d = (Math.PI * d) / 180,
                b = new g.G(
                    (Math.abs(b.width * Math.cos(d)) +
                        Math.abs(b.height * Math.sin(d))) /
                        2,
                    (Math.abs(b.width * Math.sin(d)) +
                        Math.abs(b.height * Math.cos(d))) /
                        2
                );
            a = Math.pow(2, 20 - a);
        ...
        De: function(a, b) {
            ...
            return c.add(
                new g.G(d, e).Jd(Math.pow(2, (b || this.get('zoom')) - 20))
            );
        },
        Xf: function(a, b) {
            var c = this.get('size')
                ...
                c = this.get('centerCoords').add(
                    new g.G(c, d).Jd(Math.pow(2, 20 - (b || this.get('zoom'))))
                );
            c.x = (c.x + 268435456) % 268435456;
            return c;
        },
    ...
    g.zJ = g.TS.extend({
        ...
        RR: function() {
            ...
            this.Zga = { x: a.x - g.a.Ub.x, y: a.y - g.a.Ub.y };
        ...
        CG: function() {
            ...
            if (b !== this.d3) {
                ...
                d.rotation =
                    (a.get('rotateEnable') && parseInt(this.get('rotation'))) ||
                    0;
        ...
        f2: function(a) {
            for (
                var b = this.get('centerCoords'),
                    ...
                    m = l.elements,
                    n = new g.G(0, 0),
                    p = g.Od.multiply(this.ah, this.Kc),
                    q = 0,
                    r = a.length;
                q < r;
                q++
    ...
    g.Db.ub({
        iZ: function(a, b, c) {
            var d = this;
            d.QI
                ? (g.a.VM(d.QI), (d.QI = null))
                : (d.ja('zoomstart', { zoom: a }), d.q('zoomstart'));
            d.QI = g.a.UH(
                function() {
                    d.QI = null;
                    d.ja('zoomend', { zoom: a });
            ...
            if (e !== a) {
                ...
                c = function(c) {
                    ...
                    c === a &&
                        ...
                        h && (this.ja('zoomchange'), this.ja('zoomend')),
                        k && this.q('moveend'),
                        this.q('zoomend'),
                        (this.tf = null));
                };
                ...
                b
                    ? c.call(this, a)
                    : ((this.tf = new g.Vi(e, a, null, 0.04)),
                      (this.tf.OO = h),
                      (this.tf.kB = k),
                      (this.tf.transition = function(a, b, c) {
                          return c >= g.w.nF
                              ? b
                              : (b - a) * (1 - Math.pow(1 - c / g.w.nF, 4)) + a;
                      }),
                      (this.tf.kp = c),
                      this.tf.Em(this, !0),
        ...
        gI: function(a, b, c, d) {
            ...
            if (f || h) {
                if (
                    !this.C.view.jl().contains(e) ||
                    (f && '3D' !== this.C.view.type && (g.l.Y || g.l.oe))
                )
                    c = !0;
                if (c)
                    f &&
                        (b || (this.q('zoomstart'), this.ja('zoomstart')),
                        this.set('zoom', a),
                        this.ja('zoomchange'),
                        this.ja('zoomend'),
                        this.q('zoomend')),
                        h &&
                            (k ||
                                d ||
                                (this.ja('movestart'), this.q('movestart')),
                    ...
                    !h || k || d || (this.q('movestart'), this.ja('movestart'));
                }
            }
        },
    });
    ...
    g.o.Hc = g.Z.extend({
        ...
        wg: function() {
            ...
            if (c) for (var d in g.Ea.Oi) g.a.$A(d, c) && delete g.Ea.Oi[d];
        },
        ja: function(a, b) {
            this.X.q(a, b);
        },
        ...
        opacityChanged: function() {
            ...
            if ((a = this.Fb))
                if (a.length)
                    for (var b = 0; b < a.length; b += 1) this.cR(a[b]);
                else this.cR(a);
            this.e &&
                this.e.C &&
                '3D' == this.e.C.view.type &&
                this.set('display', 0);
        },
        So: function() {
        ...
        gO: function() {
            ...
            if (a) {
                if (a instanceof g.ue) {
                    ...
                    a instanceof g.df
                        ? (this.H = [a.Sb.x, a.Sb.y, a.jd.x, a.jd.y])
                        : a instanceof g.tD &&
                          '3D' === this.X.Kp &&
                          ((b = a.path[1]),
    ...
    g.Of = g.Z.extend({
        ...
        push: function(a) {
            a = new g.Of.Qp('', a);
            0 === this.count
                ? ((this.Mc.Ba = null), (a.Ba = this.Mc), (this.Mc.next = a))
                : ((this.oA.next = a), (a.Ba = this.oA));
            this.count += 1;
            this.oA = a;
        },
        fsa: function(a) {
        ...
        qna: function() {
            if (this.count) {
                ...
                var a = this.Mc.next;
                a.next
                    ? ((a.next.Ba = this.Mc), (this.Mc.next = a.next))
                    : ((this.Mc.next = null), (this.oA = this.Mc.Ba = null));
                a.next = null;
                a.Ba = null;
                return a.value;
            }
        ...
        wU: function(a) {
            if (this.e.hasOwnProperty(a))
                return (a = this.e[a]), this.yD && (a.remove(), this.fE(a)), a;
        },
        fE: function(a) {
            this.yD
                ? ((a.next = this.Mc.next),
        ...
        gY: function(a) {
            if (!(this.count <= a || this.count < 2 * this.Kz.length)) {
                for (
                    var b = this.yD ? this.Mc.Ba : this.Mc.next,
                        c = {},
                        d = 0,
                        e = this.Kz.length;
                    d < e;
        ...
        hX: function(a) {
            this.Mc !== a &&
                (this.sF && console.log('Warnning!!!'), this.aA(a));
            return a.value;
        },
        clear: function() {
            this.e = {};
    ...
    g.bD = g.Z.extend({
        ...
        XJ: function(a) {
            a &&
                this.Bm.count >= this.xZ &&
                ((a = this.Bm.Mc.Ba.value),
                a.jm && (this.Bm.remove(a.url), this.iT(a)));
        ...
        clear: function(a) {
            ...
            this.qp.clear();
            if (a) for (; 0 < this.Bm.length; ) (a = this.Bm.pop()), this.iT(a);
            else
    ...
    g.o.gb = g.o.Hc.extend({
        ...
        nl: function() {
            ...
            return {
                ...
                md: this.X.ip
                    ? !1
                    : this.X.get('detectRetina') && g.l.ha && g.l.Y,
                Hd: this.So(),
            };
        },
        lm: function(a) {
    ...
    g.o.Qc = g.o.Hc.extend({
        ...
        zka: function(a) {
            if ('geojson' === a) return new g.v6({ map: this.map });
            if ('topjson' === a) return new g.Pta({ map: this.map });
            if ('subway' === a) return new g.Kta({ map: this.map });
        },
        zoa: function(a) {
            if (a) {
                var b = [],
                    ...
                    for (var b = a.rules, d = 0, e = b.length; d < e; d += 1) {
                        for (
                            ...
                            h[k].fill && (f[k] = new g.style.ig.sS(h[k].fill)),
                                h[k].stroke &&
                                    (f[k] = new g.style.ig.PS(h[k].stroke));
                        h = f;
                        b[d].qI = h;
        ...
        apa: function(a) {
            'px' === a.target.get('unit')
                ? ((this.af = Math.max(a.wk, this.af)),
                  (this.If = Math.max(a.wk, this.If)))
                : a.wk > this.ir &&
                  ((this.ir = a.wk),
        ...
        lF: function(a) {
            ...
            if (!this.SA && !this.X.Ki) {
                if (
                    0 === a.name.indexOf('circle') ||
                    0 === a.name.indexOf('ellipse')
                ) {
                    a.h('rad', this.apa, this);
                    var b = a.get('radius');
                    b.length && (b = Math.max.apply(null, b));
                    'px' === a.get('unit')
                        ? ((this.af = Math.max(b, this.af)),
                          (this.If = Math.max(b, this.If)))
                        : this.ir
                        ? b > this.ir &&
                          ((this.ir = b),
                          (this.qx = this.ir / this.map.C.Bi.To(20)))
        ...
        FO: function(a) {
            ...
            for (d in a)
                if (a.hasOwnProperty(d)) {
                    ...
                    h = f.get('zIndex');
                    for (e in l)
                        if (l.hasOwnProperty(e) && ((k = c[l[e]][2]), k === h))
                            break;
        ...
        featureChanged: function(a) {
            ...
            var b = a.target,
                c = b.hc();
            0 !== this.el.lka([g.a.Bb(b)]).length &&
                (this.el.remove(b, a.Vt), c && !a.Bia && this.el.add(b));
        },
        t3: function(a) {
            this.ol = !0;
            for (var b, c = 0, d = a.length; c < d; c += 1)
                (b = a[c]), (b.ba.Vt = null), b.Lq(!0), b.Ck('feature');
        },
        Bza: function(a, b) {
            return a[1].zIndex === b[1].zIndex
                ? g.a.Bb(a[1]) - g.a.Bb(b[1])
        ...
        lm: function(a) {
            return this.SA
                ? new g.N.se.Kk(this, a)
                : 'c' === this.map.get('overlayRender') && g.N.canvas.Kk
                ? new g.N.canvas.Kk(this, a)
                : g.N.Ud.Kk && 'd' === this.map.get('overlayRender')
                ? new g.N.Ud.Kk(this, a)
                : null;
        },
    });
    g.o.Qc.ub({
    ...
    g.Pj = g.Z.extend({
        r: function(a) {
            ...
            this.aI = { H: [Infinity, Infinity, -Infinity, -Infinity], Ab: [] };
            this.count = 0;
        },
        qha: function(a, b) {
            var c = -1,
            ...
            do {
                ...
                for (var h = f.length - 1; 0 <= h; h -= 1) {
                    ...
                    var l = g.Pj.Xx(
                        ...
                        k = g.Pj.Xx(
                            (k.H[2] > a.H[2] ? k.H[2] : a.H[2]) -
                                (k.H[0] < a.H[0] ? k.H[0] : a.H[0]),
                            (k.H[3] > a.H[3] ? k.H[3] : a.H[3]) -
                                (k.H[1] < a.H[1] ? k.H[1] : a.H[1]),
                            k.Ab.length + 2
                        );
        ...
        W0: function(a, b) {
            ...
            if (0 === b.Ab.length) (b.H = g.H.jb(a.H)), b.Ab.push(a);
                ...
                do {
                    ...
                    if (
                        'undefined' !== typeof e.Me ||
                        'undefined' !== typeof e.Ab ||
                        f
                    ) {
                        if (f) {
                            f = 0;
                        ...
                        if (c.Ab.length <= this.U1)
                            if (0 < d.length) e = { H: g.H.jb(c.H) };
                            else break;
                        else
                            (e = f = this.uma(c.Ab)),
                                1 > d.length &&
                                    (c.Ab.push(f[0]), d.push(c), (e = f[1]));
                    } else g.H.extend(c.H, e.H), (e = { H: g.H.jb(c.H) });
                } while (0 < d.length);
            }
        },
        uma: function(a) {
        ...
        Coa: function(a) {
            ...
            Math.abs(a[b].H[2] - a[c].H[0]) > Math.abs(a[d].H[3] - a[e].H[1])
                ? b > c
            ...
            return [{ H: g.H.jb(b.H), Ab: [b] }, { H: g.H.jb(c.H), Ab: [c] }];
        },
        Doa: function(a, b, c) {
            for (
                var d = g.Pj.Xx(
                ...
                var m = a[l],
                    ...
                    n = Math.abs(
                        g.Pj.Xx(n[1] - n[0], n[3] - n[2], b.Ab.length + 2) - d
                    ),
                    m = [
                    ...
                    m = Math.abs(
                        g.Pj.Xx(m[1] - m[0], m[3] - m[2], c.Ab.length + 2) - e
                    ),
                    p = Math.abs(m - n);
                if (!h || !f || p < f) (h = l), (f = p), (k = m < n ? c : b);
            }
            d = a.splice(h, 1)[0];
            b.Ab.length + a.length + 1 <= this.kH
                ? (b.Ab.push(d), g.H.extend(b.H, d.H))
                : c.Ab.length + a.length + 1 <= this.kH
                ? (c.Ab.push(d), g.H.extend(c.H, d.H))
                : (k.Ab.push(d), g.H.extend(k.H, d.H));
        },
        remove: function(a, b) {
            var c = [];
            c[0] = { H: a };
            ...
            if (!1 === c[1]) {
                var d = 0,
                    e = [];
                do (d = e.length), (e = e.concat(this.y3.apply(this, c)));
                while (d !== e.length);
                return e;
            }
                ...
                if ('undefined' !== typeof b)
                    for (; 0 <= k; ) {
                        ...
                        if (g.H.$f(a, l.H))
                            if (
                                (b &&
                                    'undefined' !== typeof l.Me &&
                                    l.Me === b) ||
                                (!b &&
                                    ('undefined' !== typeof l.Me ||
                                        g.H.yZ(a, l.H)))
                            ) {
                                'undefined' !== typeof l.Ab
                                    ? ((f = this.Rx(l, !0, [], l)),
                                      c.Ab.splice(k, 1))
                                    : (f = c.Ab.splice(k, 1));
                                g.Pj.BQ(c);
                    ...
                    h.length = 0;
                    0 === d.length && 1 >= c.Ab.length
                        ? ((h = this.Rx(c, !0, h, c)),
                          (c.Ab.length = 0),
                          d.push(c),
                          e.push(1))
                        : 0 < d.length && c.Ab.length < this.kH
                        ? ((h = this.Rx(c, !0, h, c)), (c.Ab.length = 0))
                        : (h = void 0);
                } else g.Pj.BQ(c);
            } while (0 < d.length);
            return f;
        ...
        search: function(a, b) {
            return this.Rx({ H: a }, !1, [], this.aI, b);
        },
        bqa: function(a, b) {
            return this.Rx({ H: a }, !1, [], this.aI, b, !0);
        },
    ...
    g.A.Dh = g.Z.extend({
        ...
        ja: function(a, b) {
            var c;
            c = b
                ? { type: a, pixel: b.vb, target: this.Wb, lnglat: b.cg }
                : { type: a };
    ...
    g.A.lb = g.A.Dh.extend({
        ...
        RK: function(a, b, c) {
            if (
                this.get('animation') &&
                'AMAP_ANIMATION_NONE' !== this.get('animation')
            ) {
                var d = this;
                this.xm = new g.Vi();
        ...
        raiseOnDragChanged: function() {
            this.get('raiseOnDrag')
                ? (this.h('dragstart', this.oX, this),
                  this.h('dragging', this.Gg, this),
                  this.h('dragend', this.kU, this))
                : (this.I('dragstart', this.oX, this),
        ...
        kr: function(a) {
            ...
            a = this.map
                .Rb(b)
                .add(a.Jd(Math.pow(2, 20 - this.map.get('zoom'))));
            b instanceof g.U
                ? this.set('position', this.map.Ee(a))
                : this.set('position', a);
        },
        GB: function(a, b) {
        ...
        offsetChanged: function() {
            ...
            if (this.L && this.L.ca) {
                ...
                '2D' == c
                    ? ((c = this.map.Rb(this.get('position'))),
                      (c = c
                          .Wa(this.L.za)
                          .Uc(Math.pow(2, 20 - this.map.get('zoom')))),
                      this.L.ca &&
                          (this.L.ca.Tz && this.L.ca.parentNode !== this.L.ca.Tz
        ...
        qT: function() {
            this.L &&
                ((this.L.Af = !0),
                this.map && ((this.map.zd.qm = !0), this.map.set('display')));
        },
        contentChanged: function() {
            if (this.L) {
                this.map.zd.qm = !0;
                -1 === g.a.indexOf(this.map.zd.ug, this.L) &&
                    this.map.zd.ug.push(this.L);
                var a = this.get('contentDom');
                this.L.ca &&
                    this.L.ca === a.parentNode &&
                    this.L.ca.removeChild(a);
                var a = this.get('content'),
                    b = this.get('offset'),
                    a = this.WY(a, b);
                this.set('contentDom', a);
                this.L.ca &&
                    (g.l.Uh && g.a.iepngFix(a),
        ...
        iconChanged: function() {
            if (this.L && this.L.ca && !this.get('content')) {
                ...
                this.L.ca &&
                    this.get('contentDom') &&
                    this.L.ca.removeChild(this.get('contentDom'));
                var a = this.get('icon'),
                    b = this.get('offset'),
                    a = this.PM(a, b);
                this.set('contentDom', a);
        ...
        titleChanged: function() {
            this.L &&
                ...
                this.L.Pg &&
                this.get('title') &&
                (this.L.Pg.title = this.get('title'));
        },
        labelChanged: function(a) {
            ...
            if (this.L && this.L.ca) {
                ...
                if (a && a.content) {
                    ...
                    if (a.content) {
                        var c = this.QM(a.content),
                            ...
                            e = 0;
                        a.offset &&
                            ((d = a.offset.y + 'px'), (e = a.offset.x + 'px'));
                        c.style.top = d;
                        c.style.left = e;
                        b.appendChild(c);
                    }
                ...
                a && a.content
                    ? this.set('labelDom', this.QM(a.content), !0)
        ...
        isTopChanged: function() {
            ...
            a
                ? a === this
                    ? this.L &&
                      this.L.ca &&
                      ((this.L.ca.style.zIndex = b ? this.map.zd.Cp + 10 : c),
                      (this.map.zd.wI = b ? this : null))
                    : (a.L &&
                          a.L.ca &&
                          (a.L.ca.style.zIndex = b
                              ? a.get('zIndex')
                              : this.map.zd.Cp + 10),
                      this.L &&
                          this.L.ca &&
                          (this.L.ca.style.zIndex = b
                              ? this.map.zd.Cp + 10
                              : c),
                      (this.map.zd.wI = b ? this : a))
                : ((this.map.zd.wI = this),
                  this.L &&
                      this.L.ca &&
                      (this.L.ca.style.zIndex = b ? this.map.zd.Cp + 10 : c));
        ...
        visibleChanged: function() {
            this.L &&
                this.L.ca &&
                (this.get('visible') && !this.Wb.get('outOfZooms')
                    ? (this.L.ca.style.display = 'block')
        ...
        zIndexChanged: function() {
            ...
            this.L &&
                this.L.ca &&
                (this.L.ca.style.zIndex = this.get('isTop')
                    ? this.map.zd.Cp + 10
                    : this.get('zIndex'));
        },
        opacityChanged: function() {
        ...
        moveChanged: function() {
            ...
            void 0 !== a &&
                ('pause' === a.action
                    ? this.Boa()
                    : '[object Array]' === Object.prototype.toString.call(a.cg)
                    ? a.cg &&
                      ('resume' === a.action && this.oE
                          ? this.moveTo(a.cg[a.cg.oo || 0], a.speed, a.rb)
                          : (this.oE && this.q('movestop'),
                            (a.cg.oo = 0),
                            this.set('position', a.cg[0]),
                            this.jna(a.cg, a.speed, a.rb, a.uha)))
                    : this.moveTo(a.cg, a.speed, a.rb, !0));
        },
        ...
        jna: function(a, b, c, d) {
            ...
            function f() {
                a.oo < a.length - 1
                    ? ((a.oo += 1), this.moveTo(a[a.oo], b, c))
                    : (this.ja('movealong'),
                      d
                          ? ((a.oo = 0),
                            this.set('position', a[0]),
                            this.moveTo(a[a.oo], b, c))
                          : this.q('movestop'));
            }
    ...
    g.A.Lm = g.A.Dh.extend({
        ...
        Yl: function() {
            this.xo.map &&
                ((this.xo.B = !0), this.xo.close(), (this.xo.B = !1));
        },
        mapChanged: function() {},
        positionChanged: function() {
            this.Gl();
        ...
        wg: function() {
            this.J &&
                (this.map.I('click', this.wua, this),
    ...
    g.A.Ge = g.A.Dh.extend({
        ...
        Lr: function() {
            ...
            if (a) {
                ...
                if (b) {
                    ...
                    if (g.l.Uh || g.l.Xq)
                        a.style.marginLeft =
                            c.childNodes[0].offsetWidth / 2 - 5;
        ...
        Gl: function() {
            ...
            if (a && b && c) {
                ...
                if (this.bN && b.childNodes[0]) {
                    ...
                    a > (this.get('size').height || b.clientHeight)
                        ? (this.bN.style.right = '20px')
                        : (this.bN.style.right = '5px');
                }
            }
        },
        m9: function() {
            var a = new g.G(
                    2 - this.Ph.offsetWidth / 2,
                    2 - this.Ph.offsetHeight
                ),
        ...
        pT: function() {
            if (this.get('position') && this.get('autoMove') && this.Ph) {
                for (
                    var a = this.map,
                        b = new g.gd(this.Ph.offsetWidth, this.Ph.offsetHeight),
                        c = a
                            .er(this.get('position'), this.get('altitude'))
                            .add(this.m9()),
                        d = c.add(b.DC()),
                        e = a.get('size'),
                        f = a.$ja(),
                ...
                0 > c.x || b.Ii() > e.Ii()
                    ? (f = 20 - c.x)
                    : e.Ii() < d.x && (f = e.Ii() - d.x - 25);
                0 > c.y || b.Gi() > e.Gi()
                    ? (l = 5 - c.y)
                    : e.Gi() < d.y && (l = e.Gi() - d.y - 15);
                f += h;
                l += k;
        ...
        Kha: function() {
            this.get('closeWhenClickMap') &&
                (this.map.h('clickstart', this.tW, this, !1),
        ...
        sW: function() {
            this.Ve.vi &&
                (this.Ve.vI &&
                    ((this.Ve.B = !0), this.Ve.close(), (this.Ve.B = !1)),
                (this.Ve.vI = !1));
        },
        wg: function() {
            this.mc &&
                ...
                ((this.Ve.vI = !1),
                this.get('closeWhenClickMap') &&
                    (this.map.I('clickstart', this.tW, this),
                    this.map.I('clickend', this.sW, this)),
                this.get('retainWhenClose')
                    ? this.map.Pk.appendChild(this.mc)
                    : (this.mc.parentNode === this.map.Pa.A &&
                          this.map.Pa.A.removeChild(this.mc),
                      (this.Ve.A = null)),
                (this.map = null),
                (this.Ve.vi = !1),
                this.Wb.q('close', { type: 'close', target: this.Wb }));
        },
        Eua: function() {
            if (!this.get('isCustom')) return this.Ph.offsetWidth;
            for (
                var a = this.Gh, b = a.firstChild, c = a.lastChild;
    ...
    g.Ah = g.Z.extend({
        ...
        $Q: function(a) {
            a &&
                ((this.ba = a), this.W('coords', a, !0), this.Fz || this.TK) &&
                (a.W('radius', this),
                a.W('center', this),
                a.W('resolution', this),
        ...
        gka: function() {
            var a = this.hc(),
                b = [];
            a.Sh() === g.va.we.iD || a.Sh() === g.va.we.fD
                ? b.push(
                      new g.style.fe.tc({
                          fillColor: '#78cdd1',
                          Vd: 0.2,
                ...
                : (a.Sh() !== g.va.we.dv && a.Sh() !== g.va.we.iJ) ||
                  b.push(
                      new g.style.fe.Ch({
            ...
            if (!this.Wf) {
                ...
                if (this.Ki) this.Wf = [a, b, a, b];
                    ...
                    var c = this.get('radius'),
                        d =
                            this.get('resolution') * this.get('strokeWeight') ||
                            0,
                        c = c
                            ? c /
                              Math.cos((Math.PI * this.get('center').Q) / 180)
                            : 0;
        ...
        vt: function(a, b, c, d) {
            ...
            if (Math.floor(e) !== e) b(c, f);
                    ...
                    for (
                        ...
                        if (m)
                            if (
                                ...
                                this.O &&
                                m.parentNode.parentNode !== this.O.Pk &&
                ...
                f.qx &&
                    (k =
                        f.qx /
                        Math.cos((Math.PI * this.e.get('center').Q) / 180));
                h = Math.max(h, k || 0);
                e = Math.max(e, k || 0);
        ...
        wB: function(a, b, c) {
            ...
            if ('circle' === a.D.type) {
                if (
                    ...
                    (c = a.D.coords[1]),
                    Math.sqrt(
                        (d[0] - b) * (d[0] - b) + (d[1] - c) * (d[1] - c)
                    ) <= a.D.coords[2])
                )
                    return !0;
            } else {
                if ('poly' === a.D.type)
                    return (e = a.D.coords), (e = this.AF(e)), g.ed.ud(d, e);
                if ('rect' === a.D.type)
                    return (
                        (e = a.D.coords),
                        (a = e[0]),
    ...
    g.GZ = {
        ...
        Oka: function(a) {
            ...
            c.Mb(a.nodes, function(a) {
                !1 !== a.value &&
                    null !== a.value &&
                    ((e[a.zoom] = g.w.nc + '://' + a.value), d.push(a.zoom));
            });
            return function(a) {
                a = c.Wc(a, 1);
        ...
        yka: function(a) {
            ...
            return function(a) {
                ...
                if (void 0 === e[a]) {
                    var k = b.rG(a, d, e);
                    e[a] =
                        f && 'none' !== f && k.rH !== k.Hx && k.sr !== k.NB
                            ? c.f0(k.sr, k.NB, (a - k.Hx) / (k.rH - k.Hx), f)
                            : k.sr;
                }
                return e[a];
            };
        ...
        Yja: function(a, b, c) {
            ...
            e.Mb(a.nodes, function(a) {
                null !== a.value &&
                    !1 !== a.value &&
                    ((h[a.zoom] = e.nga(a.value, c ? 'rgba' : 'webgl')),
                    f.push(a.zoom));
            });
            return function(a) {
                var b = null;
            ...
            for (var c = [], d = 0, e = a.length; d < e; d += 2) {
                var f = 0,
                    f =
                        'str' === b
                            ? g.a.Wc(
                                  parseInt(a.substr(d, 2), 16) /
                                      (0 === d ? 255 : 1),
                                  3
                              )
                            : g.a.Wc(parseInt(a.substr(d, 2), 16) / 255, 3);
                c.push(f);
            }
            return c.length
                ? (c.push(c.shift()),
        ...
        O2: function(a, b, c) {
            if (b[c]) console.log('customType repeat!!', c);
                ...
                var d = {},
                    e = { visible: 'visible', iR: 'showLabel', Fj: 'showIcon' },
                    f = [
                ...
                if (a.styles) {
                    a = a.styles;
                    this.BH(d, a, e, this.Rja, { Ola: !0 });
                    for (var e = 0, h = f.length; e < h; e++) {
                        var k = f[e];
                        a[k[0]]
                            ? this.BH(d, a, k[1], this.Yja, { Rla: !0 })
                            : this.BH(d, a, k[2], this.yka);
                    }
                    a.texture &&
                        (this.BH(d, a, { $a: 'texture' }, this.Oka),
                        (d.Ld = []),
            ...
            if (a)
                for (var e in a)
                    if (a.hasOwnProperty(e) && g.a.qj(a[e], 'object')) {
                        ...
                        c && (h = c + ':' + e);
                        if (f.detailedType)
                            this.O2(f, b, h), this.gQ(f.detailedType, b, h, f);
        ...
        styleChanged: function(a) {
            if (this.e.C.Wh) {
                ...
                if (a) {
                    ...
                    if (a.visible) {
                        var p = this.Qo(
                            b.K3(this.e.je.substr(1)),
                            a.opacity,
                            a.color,
                            !0
                        );
                        p &&
                            ((n = this.xy(p, a.visible, 'rgba(0, 0, 0, 0)')),
                            (p = this.kl(
                                b.hu(this.e.je.substr(1)),
                                a.opacity,
                                a.color,
                                !0
                            )),
        ...
        kl: function(a, b, c) {
            ...
            if (a) {
                ...
                if (c)
                    return 'function' === typeof c.Dg
                        ? d
                            ? c.Dg
                            : c.Dg(this.e.hf.P.zoom)
                        : c.Dg;
            }
            return a;
        },
        ...
        il: function(a, b, c, d) {
            ...
            if ((e = this.yG(b)))
                if (
                    ('function' === typeof e.visible && !e.visible(h)) ||
                    !1 === e.visible
                )
                    f = '';
                else {
                    ...
                    if (c)
                        if (e.fillColor || e.Vd) (f = e.Vd), (h = e.fillColor);
                            ...
                            if (e.color || e.opacity)
                                (f = e.opacity), (h = e.color);
                        }
                    else if (e.strokeColor || e.hb)
                        (f = e.hb), (h = e.strokeColor);
        ...
        Pq: function(a, b, c) {
            ...
            (d = this.yG(b)) &&
                (e =
                    ('function' === typeof d.visible && !d.visible(f)) ||
                    !1 === d.visible
                        ? ''
                        : c(a, d.opacity, d.color));
        ...
        Qw: function(a, b, c, d, e) {
            var f = a,
                ...
                q = this.e.hf.P.zoom;
            p &&
                (('function' === typeof p.visible && !p.visible(q)) ||
                !1 === p.visible ||
                ('function' === typeof p.iR && !p.iR(q)) ||
                !1 === p.iR
                    ? ((m = l = !1), (f = h = k = ''))
                    : ((f = this.Qo(a, p.mra, p.lra)),
        ...
        Pw: function(a, b, c, d) {
            ...
            if ((e = this.yG(c)))
                ('function' === typeof e.visible && !e.visible(k)) ||
                !1 === e.visible
                    ? (f = h = '')
                    : ((f = d(a, e.Vd, e.fillColor)),
                      (h = d(b, e.hb, e.strokeColor)));
            this.Tq === c &&
                ((b = h || b), (f = this.wt(f || a)), (h = this.wt(b)));
            return [f, h];
        },
    };
    g.N.Db.ub(g.GZ);
    g.N.canvas.Db = g.N.Db.extend({
        ...
        bc: function(a) {
                        ...
                        if ((l = l.lj()))
                            if (l.length)
                                for (m = 0; m < l.length; m += 1)
                                    l[m].parentNode === this.J &&
                                        this.J.removeChild(l[m]);
                            else
                                l.parentNode === this.J &&
                                    this.J.removeChild(l);
                    } else if (this.kP(k, d)) {
                        l.bc(a, m);
                        var k = l.lj(),
                            n,
            ...
            k = this.e.Pa.o;
            c = this.e.Pa.A;
            g.g.Pf && 'number' === typeof b.rotation && 0 !== b.rotation
                ? ((a.style[g.g.Pf + 'Origin'] = e / 2 + 'px ' + f / 2 + 'px'),
    ...
    g.N.ii = g.N.Hc.extend({
        ...
        sh: function(a, b, c) {
            ...
            a.status = 'loading';
            this.j.mn &&
                this.j.mn.call(this, a, d, function() {
                    a.loaded = !0;
                    e.j &&
                        ((a.status = 'loaded'),
                        (a.xa = !0),
                ...
                var e,
                    ...
                    p = (function() {
                        ...
                        for (e = a.length - 1; 0 <= e; e -= 1)
                            (f = a[e]), (p += f.length);
                        if (0 == p) return b.call(c, a), { HI: void 0 };
                        d.zR = a;
                        for (e = a.length - 1; 0 <= e; e -= 1)
                            for (
                                f = a[e],
                ...
                for (r = this.cb + 1; n.length && r <= k; r += 1) {
                    ...
                    for (q = l.length - 1; 0 <= q; q -= 1)
                        if (((w = l[q]), (v = s[w.key]), v & 7))
                            for (
                                v = w.sa.x << 1, x = w.sa.y << 1, w = 1;
                                0 <= w;
                                w -= 1
                            )
                                for (p.x = v + w, y = 1; 0 <= y; y -= 1)
                                    (p.y = x + y),
                                        (A = p + ''),
                                        (t = this.ra.DH(A)),
                                        s[A] & 5 && t && t.xa
                    ...
                    for (q = l.length - 1; 0 <= q; q -= 1)
                        (k = l[q]),
                            ...
                            y[k.key] ||
                                ((y[k.key] = 1),
                                (v = !1),
                                k.xa && (!this.tda || s[k.key] & 64)
                                    ? ((p.x = Math.min(
                                          c.Ac,
                                          Math.max(c.Bc, p.x << (this.cb - r))
                                      )),
                                      (p.y = Math.min(
                                          c.rc,
                                          Math.max(c.$b, p.y << (this.cb - r))
                                      )),
                                      (p.z = this.cb),
                                      (A = p + ''),
                                      'number' === typeof u[A] && k.sa.z > u[A]
                                          ? (v = !0)
                                          : (k.Pz = !0),
                                      (k.Sd = this.Sd),
                                      m.push(k),
        ...
        uO: function(a, b) {
            for (
                var c = [],
                    d = this.e.C.getCoordsBoundByZoom(a),
                    d = this.sw(d, b, a),
                    e = d.Bc;
                e < d.Ac;
                e++
    ...
    g.N.Ud.ii = g.N.ii.extend({
        ...
        HM: function(a, b) {
            if (
                !this.za ||
                3e4 < Math.abs(this.mb.x - this.za.x) / this.S ||
                3e4 < Math.abs(this.mb.y - this.za.y) / this.S
            )
                this.za = this.mb;
            this.Pe = this.Ce;
            this.Cj = this.Gf;
        ...
        Mx: function(a, b) {
            ...
            this.Uf &&
                !this.j.Ha &&
                ((c = this.j),
                c.X.Aj || g.xe.Re.end({ key: 'rb', index: 2, id: this.e.C.id }),
                (c.Ha = !0),
                c.ad
                    ? c.ja('renderComplete')
                    : ((c.ad = !0), c.ja('complete')));
        },
        bc: function(a, b) {
            this.Qr = a.Qr;
            this.sg = a.sg;
        ...
        JH: function(a, b) {
            return (
                a.$b === b.$b && a.Bc === b.Bc && a.rc === b.rc && a.Ac === b.Ac
            );
        },
        vr: function(a) {
            var b = this.Sc;
            ...
            for (d = a.length - 1; 0 <= d; d -= 1)
                if (((f = a[d]), f.length)) {
                    e = f[0].sa.z;
                    for (
                        var k, l, m = this.kI(this.Ce, e), n = f.length - 1;
                        0 <= n;
                        n -= 1
                    ) {
                        l = f[n];
                        ...
                        this.Qj && !l.Pz
                            ? ((p = Math.max(0, Math.abs(k.z - this.zoom) - 1)),
                              (r = Math.min(
                                  1,
                                  (this.currentTime - l.lU) /
                                      ((1 / Math.pow(1.32, p)) * this.ho)
                              )),
                              1 !== r && (this.zg = !0))
                            : (l.Pz = !1);
                        l.Sc = this.Sc;
                        ...
                        l.xa
                            ? ((p = l.Be),
                              ...
                              0 !== r &&
                                  p &&
                                  (this.M_(p, q.x, q.y, m, m, r, k.z),
                                  p.parentNode !== this.Fb &&
                                      (g.l.Uh &&
                                          'overlayer' === this.j.get('type') &&
    ...
    window.CanvasRenderingContext2D &&
        ((window.CanvasRenderingContext2D.prototype.nN = function(
            a,
            b,
            c,
            d,
            ...
            e.bg = 0;
            for (
                var l = [], f = this.NF, m = 0, n = 0, p = !1, q = (h = 0);
                q < e.length;
                q += 1
            )
                (e.bg += e[q]),
                    (l[q] = { YA: e[q] * d, ZA: e[q] * c, hx: (h += e[q]) }),
                    (f -= e[q]),
                    0 > f && !p && ((m = q), (n = -f), (p = !0));
            for (p = 0; n + p <= k; )
                n < e[m]
    ...
    g.N.se.Kk = g.N.ii.extend({
        ...
        Mr: function(a, b) {
            ...
            if (
                !this.za ||
                500 < Math.abs(this.fb.x - this.za.x) / this.S ||
                500 < Math.abs(this.fb.y - this.za.y) / this.S
            )
                c = !0;
            if (c || this.zoom << 0 !== this.zoom || this.Pe !== this.zoom)
                (this.za = this.fb), (this.Pe = this.zoom);
        },
        At: function(a) {
        ...
        bc: function(a, b) {
            ...
            c = c.pm(e);
            for (d in c)
                c.hasOwnProperty(d) && ((c[d].Sd = this.Sd), (c[d].B1 = this));
            this.fu(c);
                ...
                if (a.hasOwnProperty(f)) {
                    ...
                    if (h.Af)
                        (q = []),
                            ...
                            q.push('left:' + n + 'px'),
                            q.push(
                                'z-index:' + (l.n1 ? this.j.Cp + 10 : l.zIndex)
                            ),
                            g.l.oe || q.push(g.g.b0(k, l.jw, { x: s, y: u })),
                            q.push(
                                'display:' +
                                    (l.visible ? 'block' : 'none') +
                                    ';'
                            ),
        ...
        try {
            for (var wc = 0, cd = Wc.length; wc < cd; wc++) {
                ...
                if (dd && dd.version === Ac.Si)
                    ad.push(dd.script), dd.css && bd.push(dd.css);
                else {
                    ad = void 0;
                    $c = !1;
                    break;
    ...
    if (Vc) for (wc = 0; wc < Wc.length; wc += 1) g.ob.LA(Wc[wc]).status = 1;
    else (Ac.DB = !1), id();
    function jd() {
        for (
            var a = ga.getElementsByTagName('script'), b, c = 0;
            c < a.length;
            c += 1
        )
    ...
    function kd(a) {
        ...
        b.src = a;
        b.id = 'amap_plus_js';
        (a = ga.head || ga.getElementsByTagName('head')[0] || ga.body) &&
            a.appendChild(b);
    }
    function fd() {
        var a = bd.join('\n'),
        ...
        b.type = 'text/css';
        -1 === Ac.tb.indexOf('webapi.amap.com') &&
            (a = a.replace(/webapi.amap.com/gi, Ac.tb.split('://')[1]));
    ...
    '5ba23615c76f70e09bd14c39ea5903ef',
    [113.751453, 22.438581, 114.628467, 22.861748, 114.085947, 22.547],
